                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 item">
                        <div class="fun-fact">
                            ...
                            <div class="counter">
                                ...
                                <div class="timer" data-to="{{count($totalTeachers)}}" data-speed="5000" >{{count($totalTeachers)}}</div>
                    ...
                    <div class="col-lg-4 col-md-4 item">
                        <div class="fun-fact">
                            ...
                            <div class="counter">
                                <div class="timer" data-to="{{count($totalStudents)}}" data-speed="5000">{{count($totalStudents)}}</div>
                                <div class="operator">+</div>
                            </div>
