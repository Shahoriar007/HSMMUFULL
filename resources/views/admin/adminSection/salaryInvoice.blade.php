		...
		<article>
			<table class="meta">
				<tr>
					...
					<td><span contenteditable>{{$invoiceSalaryData['id']}}</span></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><span>{{$invoiceSalaryData['teacherId']}}</span></td>
				</tr>
			</table>
			<table class="inventory">
				...
				<tbody>
					<tr>
						<td style="text-align: center;"><span contenteditable>{{$invoiceSalaryData['month']}}</span></td>
						<td style="text-align: center;"><span data-prefix></span><span>{{$invoiceSalaryData['salary']}}</span></td>
					</tr>
				</tbody>
			</table>
			...
			<table class="balance">
				<tr>
					...
					<td><span data-prefix></span><span>{{$invoiceSalaryData['salary']}}</span></td>
				</tr>
			</table>
		</article>
		<aside>
