                        ...
                        <div class="nk-sidebar-menu" data-simplebar style="overflow-y:scroll;">
                            <ul class="nk-menu">
                                <li class="nk-menu-heading">
                                    ...
                                    <h6 class="overline-title text-primary-alt">Functions</h6>
                                ...
                                <li class="nk-menu-item">
                                    <a href="{{ route('studentTuitionFees') }}" class="nk-menu-link">
                                        <span class="nk-menu-icon"><em class="icon ni ni-building"></em></span>
                                        <span class="nk-menu-text">Tution Fees</span>
                                    </a>
                                </li><!-- .nk-menu-item -->
                                        ...
                                        <a href="#" class="dropdown-toggle" data-bs-toggle="dropdown">
                                            <div class="user-toggle">
                                                ...
                                                <div class="user-info d-none d-md-block">
                                                    <div class="user-status">Student Name</div>
                                            ...
                                            <div class="dropdown-inner user-card-wrap bg-lighter d-none d-md-block">
                                                <div class="user-card">
                                                    ...
                                                    <div class="user-info">
                                                        ...
                                                        <span class="sub-text">({{ Auth::guard('web')->user()->userId }})</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="dropdown-inner">
                                                <ul class="link-list">
                                                    ...
                                                    <li><a href="{{ route('changePasswordStudent') }}"><em class="icon ni ni-setting-alt"></em><span>Change Password</span></a></li>
