...
<head>
    ...
    <!-- Page Title  -->
    <title>Archive Task | CRM | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Archive Task</h3>
                                            <div class="nk-block-des text-soft">
                                                <p>You have total 15 archive task.</p>
                                            </div>
                                                ...
                                                <table class="nk-tb-list nk-tb-ulist">
                                                    ...
                                                    <tbody>
                                                                ...
                                                                <ul class="nk-tb-actions gx-1">
                                                                    <li>
                                                                        <div class="drodown">
                                                                            ...
                                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                                <ul class="link-list-opt no-bdr">
                                                                                    <li><a data-bs-toggle="modal" href="#restoreTask" class="eg-toastr-top-center"><em class="icon ni ni-unarchive"></em><span>Restore Task</span></a></li>
                                                                                    <li><a data-bs-toggle="modal" href="#taskDelete" class="eg-toastr-error"><em class="icon ni ni-delete"></em><span>Delete Task</span></a></li>
                                                                                </ul>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                        ...
                                                        <tr class="nk-tb-item">
                                                            ...
                                                            <td class="nk-tb-col tb-col-md">
                                                                <ul class="d-flex flex-wrap g-1">
                                                                    <li><span class="badge badge-dim bg-danger">Web</span></li>
                                                                    <li><span class="badge badge-dim bg-primary">Design</span></li>
