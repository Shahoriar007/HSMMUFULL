...
<head>
    ...
    <!-- Page Title  -->
    <title>Product Transfer | CRM | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Product Transfer</h3>
                                            ...
                                            <div class="row gy-4 pt-3">
                                                                ...
                                                                <div class="g w-100">
                                                                    <div class="form-control-wrap">
                                                                        <select class="form-select js-select2">
                                                                            <option value="default_option">Laptop</option>
                                                                            <option value="phone">Phone</option>
                                                                            <option value="casing">Casing</option>
                                                                            <option value="mac_book">Mac Book</option>
                                                                            <option value="chair">Chair</option>
                                                                            <option value="samsung_galaxy_J7">Samsung Galaxy J7</option>
                                                                            <option value="xaomi_note_9">Xaomi Note 9</option>
                                                ...
                                                <div class="col-lg-4 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <select class="form-select js-select2">
                                                                <option value="default_option">Technology</option>
                                                                <option value="electric">Electric</option>
                                                                <option value="phone">Furniture</option>
                                                                <option value="mac_book">Tools</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <select class="form-select js-select2">
                                                                <option value="default_option">ASUS Zenbook</option>
                                                                <option value="electric">Brompton</option>
                                                                <option value="phone">Gamemax Rockstar</option>
                                                                <option value="quadcopter">Quadcopter</option>
                                                                <option value="McDonald">McDonald's</option>
                                                                <option value="Cisco">Cisco</option>
                                                                <option value="A4tech">A4tech</option>
                                                                <option value="ATH_G1WL">ATH-G1WL</option>
                                                ...
                                                <div class="col-lg-4 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="number" class="form-control" id="qty" placeholder="e.g. 10" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="number" class="form-control" id="price" placeholder="e.g. $100.00" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div><!--row-->
                                            <h5 class="title pt-5">Warehouse Address</h5>
                                            <div class="row gy-4 pt-3">
                                                <div class="col-lg-4 col-md-6">
                                                    <div class="form-group">
                                                        <label class="form-label">Transfer From (warehouse)</label>
                                                        <div class="form-control-wrap">
                                                            <select class="form-select js-select2">
                                                ...
                                                <div class="col-lg-4 col-md-6">
                                                    <div class="form-group">
                                                        <label class="form-label">Transfer To (warehouse)</label>
                                                        <div class="form-control-wrap">
                                                            <div class="d-flex gx-3">
                                                                <div class="g w-100">
                                                                    <div class="form-control-wrap">
