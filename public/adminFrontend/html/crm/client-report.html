...
<head>
    ...
    <!-- Page Title  -->
    <title>Client Report | CRM | DashLite Admin Template</title>
    <!-- StyleSheets  -->
...
<body class="nk-body bg-lighter npc-general has-sidebar ">
                        ...
                        <div class="nk-content-inner">
                            <div class="nk-content-body">
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Client Report</h3>
                                                            ...
                                                            <div class="drodown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end">
                                                                    <ul class="link-list-opt no-bdr">
                                                                        <li><a href="#"><span>10 days</span></a></li>
                                                                        <li><a href="#"><span>20 days</span></a></li>
                                ...
                                <div class="nk-block-head">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Client's Projects</h3>
                                            <div class="nk-block-des text-soft">
                                                <p>You have total 595 client's project.</p>
                                            </div>
                                        </div><!-- .nk-block-head-content -->
                                        <div class="nk-block-head-content">
                                            <div class="toggle-wrap nk-block-tools-toggle">
                                                ...
                                                <div class="card-title-group">
                                                    ...
                                                    <div class="card-search search-wrap" data-search="search">
                                                        <div class="search-content">
                                                            ...
                                                            <input type="text" class="form-control form-control-sm border-transparent form-focus-none" placeholder="Search by customer or email">
                                            ...
                                            <div class="card-inner p-0">
                                                <div class="nk-tb-list nk-tb-ulist">
                                                    <div class="nk-tb-item nk-tb-head">
                                                        ...
                                                        <div class="nk-tb-col tb-col-mb"><span class="sub-text d-lg-flex d-none">Projects</span></div>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <span class="tb-lead d-lg-flex d-none">IT Solution</span>
                                                                ...
                                                                <div class="drodown">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-left">
                                                                        <ul class="link-list-opt no-bdr p-3">
                                                                            <li class="tb-lead p-1">Internet configuration</li>
                                                                            <li class="tb-lead p-1">Database Management</li>
                                                                            <li class="tb-lead p-1">Design tool</li>
                                                                            <li class="tb-lead p-1">Banner completation</li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <ul class="nk-tb-actions gx-1">
                                                                ...
                                                                <li>
                                                                    <div class="drodown">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-end">
                                                                            <ul class="link-list-opt no-bdr">
                                                                                <li><a data-bs-toggle="modal" href="#editProjectData"><em class="icon ni ni-edit"></em><span>Edit Info</span></a></li>
                                                                                <li><a data-bs-toggle="modal" href="#deleteData"><em class="icon ni ni-delete"></em><span>Delete</span></a></li>
                                                                            </ul>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <span class="tb-lead d-lg-flex d-none">Internet configuration</span>
                                                            <div class="d-lg-flex d-none">
                                                                <div class="drodown">
                                                                    <a href="#" class="dropdown-toggle pt-1 text-info" data-bs-toggle="dropdown"> <span>View More</span> </a>
                                                                    <div class="dropdown-menu dropdown-menu-left">
                                                                        <ul class="link-list-opt no-bdr p-3">
                                                                            <li class="tb-lead p-1">IT Solution</li>
                                                                            <li class="tb-lead p-1">Database Management</li>
                                                                            <li class="tb-lead p-1">Design tool</li>
                                                                            <li class="tb-lead p-1">Banner completation</li>
                                                                        </ul>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <span class="tb-lead d-lg-flex d-none">Database Management</span>
                                                            <div class="d-lg-flex d-none">
                                                                <div class="drodown">
                                                                    <a href="#" class="dropdown-toggle pt-1 text-info" data-bs-toggle="dropdown"> <span>View More</span> </a>
                                                                    <div class="dropdown-menu dropdown-menu-left">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <span class="tb-lead d-lg-flex d-none">Design tool</span>
                                                            <div class="d-lg-flex d-none">
                                                                <div class="drodown">
                                                                    <a href="#" class="dropdown-toggle pt-1 text-info" data-bs-toggle="dropdown"> <span>View More</span> </a>
                                                                    <div class="dropdown-menu dropdown-menu-left">
                                                        ...
                                                        <div class="nk-tb-col tb-col-lg">
                                                            <span class="tb-status badge-dot bg-danger">Canceled</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-md">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <span class="tb-lead d-lg-flex d-none">Banner completation</span>
                                                            <div class="d-lg-flex d-none">
                                                                <div class="drodown">
                                                                    <a href="#" class="dropdown-toggle pt-1 text-info" data-bs-toggle="dropdown"> <span>View More</span> </a>
                                                                    <div class="dropdown-menu dropdown-menu-left">
                                                                        <ul class="link-list-opt no-bdr p-3">
                                                                            ...
                                                                            <li class="tb-lead p-1">Internet configuration</li>
                                                                            <li class="tb-lead p-1">Database Management</li>
                                                                            <li class="tb-lead p-1">Design tools configuration</li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                            </div>
                        ...
                        <div class="row g-gs">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="p-name">Project Name</label>
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" id="p-name" value="Dashlite Development">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" id="client" value="Softnio">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="t-price">Total Expense</label>
                                    <div class="form-control-wrap">
                                        <input type="number" class="form-control" id="t-price" value="5454.00">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="code">Monthly Expense</label>
                                    <div class="form-control-wrap">
                                        <input type="number" class="form-control" id="code" value="1564.00">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="w-price">Weekly Expense</label>
                                    <div class="form-control-wrap">
                                        <input type="number" class="form-control" id="w-price" value="605.00">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="d-price">Daily Expense</label>
                                    <div class="form-control-wrap">
                                        <input type="number" class="form-control" id="d-price" value="155.00">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <button data-bs-dismiss="modal" type="submit" class="btn btn-primary">Update Expense</button>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <div class="modal fade" id="editProjectData">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <a href="#" class="close" data-bs-dismiss="modal" aria-label="Close">
                    <em class="icon ni ni-cross-sm"></em>
                ...
                <div class="modal-body modal-body-md">
                    <h5 class="modal-title">Edit Client Project Data</h5>
                    <form action="#" class="mt-2">
                        <div class="row g-gs">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" id="name" value="Frances Burns">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="email" class="form-control" id="email" value="frances@example.com">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" id="phone" value="+811 847-4958">
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <select class="form-select js-select2" data-ui="lg">
                                            <option value="default_option">Nepal</option>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <div class="d-flex gx-3 mb-3">
                                        <div class="g w-100">
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" value="Dadtabase Management">
                                            </div>
                                        </div>
                                        <div class="g">
                                    ...
                                    <div class="d-flex gx-3 mb-3">
                                        <div class="g w-100">
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" value="IT Solution">
                                            </div>
                                        </div>
                                        <div class="g">
                                            <button class="btn btn-icon btn-outline-light"><em class="icon ni ni-cross"></em></button>
                                    ...
                                    <div class="d-flex gx-3 mb-3">
                                        <div class="g w-100">
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" value="Server Secure">
                                            </div>
                                        </div>
                                        <div class="g">
                                            <button class="btn btn-icon btn-outline-light"><em class="icon ni ni-cross"></em></button>
                                    ...
                                    <div class="d-flex gx-3 mb-3">
                                        <div class="g w-100">
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" placeholder="e.g. Internet configuration">
                                            </div>
                                        </div>
                                        <div class="g">
                                        ...
                                        <ul class="custom-control-group g-3 align-center flex-wrap">
                                            <li>
                                                <div class="custom-control custom-radio">
                                                    ...
                                                    <label class="custom-control-label" for="reg-enable">Paid</label>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" class="custom-control-input" name="reg-public" id="reg-disable">
                                                    <label class="custom-control-label" for="reg-disable">Due</label>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" class="custom-control-input" name="reg-public" id="reg-request">
                                                    <label class="custom-control-label" for="reg-request">Cenceled</label>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <ul class="custom-control-group g-3 align-center flex-wrap">
                                            <li>
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" class="custom-control-input" checked="" name="status" id="active">
                                                    <label class="custom-control-label" for="active">Active</label>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" class="custom-control-input" name="status" id="inactive">
                                                    <label class="custom-control-label" for="inactive">Inactive</label>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" class="custom-control-input" name="status" id="suspend">
                                                    <label class="custom-control-label" for="suspend">Suspend</label>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <button data-bs-dismiss="modal" type="submit" class="btn btn-primary">Update Project</button>
                                </div>
                            </div>
                        </div>
                    </form>
    ...
    <script src="./assets/js/charts/chart-crm.js?ver=3.1.1"></script>
</body>
