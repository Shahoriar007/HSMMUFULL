...
<head>
    ...
    <!-- Page Title  -->
    <title>Products | CRM | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                                                ...
                                                <div class="toggle-expand-content" data-content="pageMenu">
                                                    <ul class="nk-block-tools g-3">
                                                        ...
                                                        <li class="nk-block-tools-opt d-none d-sm-block">
                                                            <a class="btn btn-primary" data-bs-toggle="modal" href="#addProduct"><em class="icon ni ni-plus"></em><span>Add Project</span></a>
                                                        </li>
                                                        <li class="nk-block-tools-opt d-block d-sm-none">
                                                            <a class="btn btn-icon btn-primary" data-bs-toggle="modal" href="#addProduct"><em class="icon ni ni-plus"></em></a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div><!-- .toggle-wrap -->
                                                ...
                                                <table class="nk-tb-list nk-tb-ulist">
                                                    <thead>
                                                        <tr class="nk-tb-item nk-tb-head">
                                                            ...
                                                            <th class="nk-tb-col tb-col-xxl"><span class="sub-text">Code</span></th>
                                                    ...
                                                    <tbody>
                                                        <tr class="nk-tb-item">
                                                            ...
                                                            <td class="nk-tb-col tb-col-xxl">
                                                                <span class="badge badge-dim bg-outline-primary">Available</span>
                                                            </td>
                                                            <td class="nk-tb-col tb-col-xxl">
                                                                <span>Samsung</span>
                                                            </td>
                                                                        ...
                                                                        <div class="drodown">
                                                                            ...
                                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                                <ul class="link-list-opt no-bdr">
                                                                                    ...
                                                                                    <li><a data-bs-toggle="modal" href="#editProduct"><em class="icon ni ni-edit"></em><span>Edit Product</span></a></li>
                                                                                    <li><a data-bs-toggle="modal" href="#deleteProduct"><em class="icon ni ni-delete"></em><span>Delete Product</span></a></li>
                                                                                </ul>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                        ...
                                                        <tr class="nk-tb-item">
                                                            ...
                                                            <td class="nk-tb-col tb-col-xxl">
                                                                <span class="badge badge-dim bg-outline-danger">Out of Stock</span>
                                                            </td>
                                                            <td class="nk-tb-col tb-col-xxl">
                                                                <span>Brompton</span>
                                                            </td>
