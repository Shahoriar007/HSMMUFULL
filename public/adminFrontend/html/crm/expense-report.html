...
<head>
    ...
    <!-- Page Title  -->
    <title>Expense Report | CRM | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Expense Report</h3>
                                            <div class="nk-block-des text-soft">
                                                <p>Expense Report details.</p>
                                            </div>
                                                ...
                                                <div class="card-inner">
                                                    <div class="card-title-group pb-3 g-2">
                                                        <div class="card-title card-title-sm">
                                                            <h6 class="title">Expense Report</h6>
                                                            <p>Project Expense Total Statistics</p>
                                                        </div>
                                                ...
                                                <table class="nk-tb-list nk-tb-ulist">
                                                    <thead>
                                                        <tr class="nk-tb-item nk-tb-head">
                                                            ...
                                                            <th class="nk-tb-col"><span class="sub-text">Total Expense</span></th>
                                                            <th class="nk-tb-col tb-col-md"><span class="sub-text">Monthly Expense</span></th>
                                                            <th class="nk-tb-col tb-col-xl"><span class="sub-text">Weekly Expense</span></th>
                                                            <th class="nk-tb-col tb-col-md"><span class="sub-text">Daily Expense</span></th>
                                                            <th class="nk-tb-col nk-tb-col-tools text-end gx-1">
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-end">
                                                                        <ul class="link-list-opt no-bdr">
                                                                            ...
                                                                            <li><a href="#"><em class="icon ni ni-trash"></em><span>Remove Data</span></a></li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                            </th>
                                                                ...
                                                                <ul class="nk-tb-actions gx-1">
                                                                    <li>
                                                                        <div class="drodown">
                                                                            ...
                                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                                <ul class="link-list-opt no-bdr">
                                                                                    <li><a data-bs-toggle="modal" href="#editData"><em class="icon ni ni-edit"></em><span>Edit Expense</span></a></li>
                                                                                    <li><a data-bs-toggle="modal" href="#deleteData"><em class="icon ni ni-delete"></em><span>Delete Expense</span></a></li>
                                                                                </ul>
                                                                            </div>
                                                                        </div>
                                                                    </li>
