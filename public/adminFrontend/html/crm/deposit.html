...
<head>
    ...
    <!-- Page Title  -->
    <title>Deposit | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                                                ...
                                                <div class="toggle-expand-content" data-content="pageMenu">
                                                    <ul class="nk-block-tools g-3">
                                                        ...
                                                        <li class="nk-block-tools-opt d-none d-sm-block">
                                                            <a class="btn btn-primary" data-bs-toggle="modal" href="#addDeposit"><em class="icon ni ni-plus"></em>
                                                                <span>Add Deposit</span>
                                                            </a>
                                                        </li>
                                                        <li class="nk-block-tools-opt d-block d-sm-none">
                                                            <a class="btn btn-icon btn-primary" data-bs-toggle="modal" href="#addDeposit"><em class="icon ni ni-plus"></em></a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div><!-- .toggle-wrap -->
                                                ...
                                                <table class="nk-tb-list nk-tb-ulist">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="nk-tb-item">
                                                            ...
                                                            <td class="nk-tb-col">
                                                                <div class="user-card">
                                                                    ...
                                                                    <div class="user-name">
                                                                        <span class="tb-lead">Rose King</span>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td class="nk-tb-col tb-col-lg">
                                                        ...
                                                        <tr class="nk-tb-item">
                                                            ...
                                                            <td class="nk-tb-col">
                                                                <div class="user-card">
                                                                    ...
                                                                    <div class="user-name">
                                                                        <span class="tb-lead">Yousifa Cross</span>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td class="nk-tb-col tb-col-lg">
                                                        ...
                                                        <tr class="nk-tb-item">
                                                            <td class="nk-tb-col nk-tb-col-check">
                                                                <div class="custom-control custom-control-sm custom-checkbox notext">
                                                                    <input type="checkbox" class="custom-control-input" id="pid-11">
                                                                    <label class="custom-control-label" for="pid-11"></label>
                                                                </div>
                                                            </td>
                                                            <td class="nk-tb-col">
                                                                <div class="user-card">
