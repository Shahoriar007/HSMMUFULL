...
<head>
    ...
    <!-- Page Title  -->
    <title>CRM | Subscription | DashLite Admin Template</title>
    <!-- StyleSheets  -->
...
<body class="nk-body bg-lighter npc-general has-sidebar ">
                                    ...
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            ...
                                            <div class="nk-block-des text-soft">
                                                <p>You have total 95 Subscriptions.</p>
                                            </div>
                                                            ...
                                                            <div class="drodown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end">
                                                                    <ul class="link-list-opt no-bdr">
                                                                        <li><a data-bs-toggle="modal" href="#addSubscription"><span>Add Subscription</span></a></li>
                                                                        <li><a href="#"><span>Import Subscription</span></a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </li>
                                                        ...
                                                        <div class="form-inline flex-nowrap gx-3">
                                                            <div class="form-wrap w-150px">
                                                                <select class="form-select js-select2 js-select2-sm" data-search="off" data-placeholder="Bulk Action">
                                                                    ...
                                                                    <option value="paln">Change Plan</option>
                                                                                            ...
                                                                                            <div class="row gx-6 gy-3">
                                                                                                <div class="col-6">
                                                                                                    <div class="custom-control custom-control-sm custom-checkbox">
                                                                                                        <input type="checkbox" class="custom-control-input" id="subActive">
                                                                                                        <label class="custom-control-label" for="subActive"> Active</label>
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div class="col-6">
                                                                                                    <div class="custom-control custom-control-sm custom-checkbox">
                                                                                                        <input type="checkbox" class="custom-control-input" id="subDue">
                                                                                                        <label class="custom-control-label" for="subDue">Due</label>
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div class="col-6">
                                                                                                    <div class="form-group">
                                                                                                        <label class="overline-title overline-title-alt">Plan</label>
                                            ...
                                            <div class="card-inner p-0">
                                                <div class="nk-tb-list nk-tb-ulist">
                                                    <div class="nk-tb-item nk-tb-head">
                                                        ...
                                                        <div class="nk-tb-col tb-col-lg"><span class="sub-text">Plan</span></div>
                                                        ...
                                                        <div class="nk-tb-col tb-col-xxl"><span class="sub-text">Reneweed Date</span></div>
                                                                    ...
                                                                    <div class="drodown">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-end">
                                                                            <ul class="link-list-opt no-bdr">
                                                                                ...
                                                                                <li><a data-bs-toggle="modal" href="#editSubscription"><em class="icon ni ni-edit"></em><span>Edit</span></a></li>
                                                                                <li><a data-bs-toggle="modal" href="#deleteSubscription"><em class="icon ni ni-delete"></em><span>Delete</span></a></li>
                                                                            </ul>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name">
                                                                    <span class="tb-lead">Barry Wayne<span class="dot dot-success d-md-none ms-1"></span></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name">
                                                                    <span class="tb-lead">Jahangir Alom<span class="dot dot-success d-md-none ms-1"></span></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                        ...
                                                        <div class="nk-tb-col tb-col-md">
                                                            <span class="tb-status bg-danger badge badge-dot">Canceled</span>
                                                        </div>
                                                        <div class="nk-tb-col">
                                                            <span>&nbsp;</span>
                                                        </div>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name">
                                                                    <span class="tb-lead">Fuad Alom<span class="dot dot-warning d-md-none ms-1"></span></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col tb-col-sm">
                                                            <span>ishtiyak@softnio.com</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-xxl">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name">
                                                                    <span class="tb-lead">Bruce Waltter<span class="dot dot-success d-md-none ms-1"></span></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name">
                                                                    <span class="tb-lead">Jahangir Alom<span class="dot dot-danger d-md-none ms-1"></span></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name">
                                                                    <span class="tb-lead">Lara Watson<span class="dot dot-warning d-md-none ms-1"></span></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
    ...
    <!-- @@ Subscription Add Modal @e -->
    <div class="modal fade" role="dialog" id="addSubscription">
        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
            <div class="modal-content">
                <a href="#" class="close" data-bs-dismiss="modal"><em class="icon ni ni-cross-sm"></em></a>
                <div class="modal-body modal-body-md">
                    <h5 class="title">Add Subscriber</h5>
                    <ul class="nk-nav nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#infomation">Subscriber Detail's</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#plan">Plan Detail's</a>
                        </li>
                    </ul><!-- .nav-tabs -->
                            ...
                            <div class="row gy-4">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control" id="sub-name" placeholder="Name">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control" id="sub-email" placeholder="Email">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label" for="join-date">Joining Date</label>
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control date-picker" id="join-date" placeholder="mm/dd/yyy">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label" for="sub-group">Group</label>
                                        <div class="form-control-wrap">
                                            <select class="form-select js-select2" id="sub-group">
                                                <option value="default_option">Group</option>
                                ...
                                <div class="col-12">
                                    <ul class="align-center flex-wrap flex-sm-nowrap gx-4 gy-2">
                                        <li>
                                            <a href="#" data-bs-dismiss="modal" class="btn btn-primary">Add Subscriber</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="row gy-4">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap ">
                                            <select class="form-select js-select2" id="sub-plan">
                                                <option value="default_option">Basic</option>
                                                <option value="unlimited">Unlimited</option>
                                                <option value="pro">Pro</option>
                                            </select>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label" for="sub-pay">Payment</label>
                                        <div class="form-control-wrap ">
                                            <select class="form-select js-select2" id="sub-pay">
                                                <option value="default_option">Payment</option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="sub-amount" placeholder="$">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <select class="form-select js-select2" id="sub-status">
                                                <option value="default_option">Status</option>
                                                <option value="active">Active</option>
                                                <option value="pending">Pending</option>
                                                <option value="cenceled">Canceld</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
    ...
    <!-- @@ Subscription Edit Modal @e -->
    <div class="modal fade" role="dialog" id="editSubscription">
        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
            <div class="modal-content">
                <a href="#" class="close" data-bs-dismiss="modal"><em class="icon ni ni-cross-sm"></em></a>
                <div class="modal-body modal-body-md">
                    <h5 class="title">Edit Subscriber</h5>
                    <ul class="nk-nav nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#editInfo">Subscriber Detail's</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#editPlan">Plan Detail's</a>
                        </li>
                    </ul><!-- .nav-tabs -->
                    <div class="tab-content">
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control" id="edit-email" placeholder="Email" value="info@softnio.com">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label" for="edit-date">Joining Date</label>
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control date-picker" id="edit-date" placeholder="mm/dd/yyy" value="14 Feb 2020">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label" for="edit-group">Group</label>
                                        <div class="form-control-wrap ">
                                            <select class="form-select js-select2" id="edit-group">
                                                <option value="default_option">Group</option>
                                                <option value="silver">Silver</option>
                                                <option value="gold">Gold</option>
                                                <option value="platinum">Platinum</option>
                                ...
                                <div class="col-12">
                                    <ul class="align-center flex-wrap flex-sm-nowrap gx-4 gy-2">
                                        <li>
                                            <a href="#" data-bs-dismiss="modal" class="btn btn-primary">Update Subscriber</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        </div><!-- .tab-pane -->
                        <div class="tab-pane" id="editPlan">
                            <div class="row gy-4">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label" for="edit-plan">Plan</label>
                                        <div class="form-control-wrap ">
                                            <select class="form-select js-select2" id="edit-plan">
                                                <option value="default_option">Basic</option>
                                                <option value="basic">Basic</option>
                                                <option value="unlimited">Unlimited</option>
                                                <option value="pro">Pro</option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label" for="edit-pay">Payment</label>
                                        <div class="form-control-wrap ">
                                            <select class="form-select js-select2" id="edit-pay">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="edit-amount" placeholder="$" value="$535.00">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <select class="form-select js-select2" id="edit-status">
                                                ...
                                                <option value="active">Active</option>
                                                <option value="pending">Pending</option>
                                                <option value="cancelled">Canceld</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
    ...
    <!-- @@ Subscription Delete Modal @e -->
    <div class="modal fade" id="deleteSubscription">
                ...
                <div class="modal-body modal-body-sm text-center">
                    <div class="nk-modal py-4">
                        ...
                        <div class="nk-modal-text mt-n2">
                            <p class="text-soft">This subscription will be removed permanently.</p>
                        </div>
