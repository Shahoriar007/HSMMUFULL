...
<head>
    ...
    <!-- Page Title  -->
    <title>Employees List | CRM | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                                                            ...
                                                            <div class="drodown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end">
                                                                    <ul class="link-list-opt no-bdr">
                                                                        <li><a data-bs-toggle="modal" href="#addData"><span>Add Member</span></a></li>
                                                                                                ...
                                                                                                <div class="col-6">
                                                                                                    <div class="form-group">
                                                                                                        ...
                                                                                                        <select class="form-select js-select2 js-select2-sm">
                                                                                                            ...
                                                                                                            <option value="pending">Software Developer</option>
                                                                    ...
                                                                    <div class="drodown">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-end">
                                                                            <ul class="link-list-opt no-bdr">
                                                                                ...
                                                                                <li><a data-bs-toggle="modal" href="#editData"><em class="icon ni ni-edit"></em><span>Edit Data</span></a></li>
