...
<head>
    ...
    <!-- Page Title  -->
    <title>CRM | Expenses | DashLite Admin Template</title>
    <!-- StyleSheets  -->
...
<body class="nk-body bg-lighter npc-general has-sidebar ">
                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content me-2">
                                            <h3 class="nk-block-title page-title wide-sm">Expenses List</h3>
                                                                                            ...
                                                                                            <div class="row gx-6 gy-3">
                                                                                                <div class="col-6">
                                                                                                    <div class="form-group">
                                                                                                        <label class="overline-title overline-title-alt">Project</label>
                                            ...
                                            <div class="card-inner p-0">
                                                <div class="nk-tb-list nk-tb-ulist">
                                                    <div class="nk-tb-item nk-tb-head">
                                                        ...
                                                        <div class="nk-tb-col tb-col-lg"><span class="sub-text">Project</span></div>
                                                        <div class="nk-tb-col tb-col-mb"><span class="sub-text">Client</span></div>
                                                        <div class="nk-tb-col tb-col-lg"><span class="sub-text">Invoice ID</span></div>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name">
                                                                    <span class="tb-lead">Abu Bin Ishtiyak<span class="dot dot-success d-sm-none ms-1"></span></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                                    ...
                                                                    <div class="drodown">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-end">
                                                                            <ul class="link-list-opt no-bdr">
                                                                                ...
                                                                                <li><a data-bs-toggle="modal" href="#editExpenses"><em class="icon ni ni-edit"></em><span>Edit</span></a></li>
                                                                                <li><a data-bs-toggle="modal" href="#deleteExpense"><em class="icon ni ni-delete"></em><span>Delete</span></a></li>
                                                                            </ul>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name">
                                                                    <span class="tb-lead">Barry Wayne<span class="dot dot-info d-sm-none ms-1"></span></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                        ...
                                                        <div class="nk-tb-col tb-col-xxl">
                                                            <span>Demonstrate the visual form.</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                        ...
                                                        <div class="nk-tb-col tb-col-sm">
                                                            <span class="tb-status bg-info badge badge-dot">Billable</span>
                                                        </div>
                                                        <div class="nk-tb-col nk-tb-col-tools">
                                                            <ul class="nk-tb-actions gx-2">
                                                                <li>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name">
                                                                    <span class="tb-lead">Fuad Hossain<span class="dot dot-warning d-sm-none ms-1"></span></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                        ...
                                                        <div class="nk-tb-col tb-col-xxl">
                                                            <span>In publishing and graphic.</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name">
                                                                    <span class="tb-lead">Athan Travis<span class="dot dot-success d-sm-none ms-1"></span></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                        ...
                                                        <div class="nk-tb-col tb-col-xxl">
                                                            <span>Lorem ipsum used as placeholder</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                            <span>Database Management</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <span>Asia paints</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                            <a href="#">
                                                                <span>INV-132</span>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name">
                                                                    <span class="tb-lead">Konsta Peura<span class="dot dot-info d-sm-none ms-1"></span></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                        ...
                                                        <div class="nk-tb-col tb-col-xxl">
                                                            <span>Document typeface without relying.</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                            <span>IT Solution</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <span>Amul group</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                            <a href="#">
                                                                <span>-</span>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name">
                                                                    <span class="tb-lead">Wyatt Morris<span class="dot dot-success d-sm-none ms-1"></span></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name">
                                                                    <span class="tb-lead">Amilia Luna<span class="dot dot-warning d-sm-none ms-1"></span></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                        ...
                                                        <div class="nk-tb-col tb-col-xxl">
                                                            <span>Lorem ipsum was introduced to.</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name">
                                                                    <span class="tb-lead">Anne Mcfadden<span class="dot dot-success d-sm-none ms-1"></span></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                        ...
                                                        <div class="nk-tb-col tb-col-xxl">
                                                            <span>Employed it in graphic word.</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                            <span>Banner Completation</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-mb">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name">
                                                                    <span class="tb-lead">Eliana Stout<span class="dot dot-success d-sm-none ms-1"></span></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                        ...
                                                        <div class="nk-tb-col tb-col-xxl">
                                                            <span>Consectetur adipiscing sed do.</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                            <span>Redesign Website</span>
                                                        </div>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name">
                                                                    <span class="tb-lead">Aatu Juntunen<span class="dot dot-success d-sm-none ms-1"></span></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
    ...
    <!-- @@ edit Expenses Modal @@ -->
    <div class="modal fade" id="editExpenses">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body modal-body-md">
                    ...
                    <form action="#" class="mt-2">
                        <div class="row g-gs">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="ex-id">ID</label>
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" id="ex-id" placeholder="ID" value="EX-99" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="ex-user">User</label>
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" id="ex-user" placeholder="User" value="Abu Bin Ishtiyak" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="ex-project">Project</label>
                                    <div class="form-control-wrap">
                                        <select class="form-select js-select2" id="ex-project">
                                            <option value="default_option">IT Solution</option>
                                            <option value="redesign">Redesign Website</option>
                                            <option value="keyword">Keyword Research for SEO</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control date-picker" id="ex-date" placeholder="mm/dd/yyyy" value="02/10/2021">
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        ...
                                        <div class="quill-minimal">
                                            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Mollitia, fugit. Quod quam corrupti a ratione fugit obcaecati qui repellendus fuga.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label class="form-label" for="ex-client">Client</label>
                                    <div class="form-control-wrap">
                                        <select class="form-select js-select2" id="ex-client">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" id="ex-amount" placeholder="$" value="$535.00">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <select class="form-select js-select2" id="ex-status">
                                            <option value="default_option">Paid</option>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <button type="submit" data-bs-dismiss="modal" class="btn btn-primary">Update Expense</button>
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="modal-body modal-body-sm text-center">
                    <div class="nk-modal py-4">
                        ...
                        <div class="nk-modal-text mt-n2">
                            <p class="text-soft">This Expense data will be delete permanently.</p>
                        </div>
