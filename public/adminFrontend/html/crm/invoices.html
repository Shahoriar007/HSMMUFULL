...
<head>
    ...
    <!-- Page Title  -->
    <title>CRM | Invoices | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                        ...
                        <div class="row g-gs">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="oder-id">Order ID</label>
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" id="oder-id" placeholder="1">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" id="item-code" placeholder="01">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <button data-bs-dismiss="modal" type="submit" class="btn btn-primary">Add Invoice</button>
                            </div>
                        </div>
                    </form>
                </div>
