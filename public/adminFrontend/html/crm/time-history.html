...
<head>
    ...
    <!-- Page Title  -->
    <title>CRM - Attendance History | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Employee Attendance History</h3>
                                            ...
                                            <div class="toggle-wrap nk-block-tools-toggle">
                                                ...
                                                <div class="toggle-expand-content" data-content="pageMenu">
                                                    <ul class="nk-block-tools g-3">
                                                        ...
                                                        <li><a href="#" class="btn btn-primary"><em class="icon ni ni-upload-cloud"></em><span>Import</span></a></li>
                                                    </ul>
                                                </div>
                                            </div><!-- .toggle-wrap -->
                                        </div><!-- .nk-block-head-content -->
                                                        ...
                                                        <div class="form-inline flex-nowrap gx-3">
                                                            <div class="form-wrap w-150px">
                                                                <select class="form-select js-select2 js-select2-sm" data-search="off" data-placeholder="Bulk Action">
                                                                    <option value="ba">Bulk Action</option>
                                                                                            ...
                                                                                            <div class="row gx-6 gy-3">
                                                                                                <div class="col-6">
                                                                                                    <div class="custom-control custom-control-sm custom-checkbox">
                                                                                                        <input type="checkbox" class="custom-control-input" id="empActive">
                                                                                                        <label class="custom-control-label" for="empActive">Active</label>
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div class="col-6">
                                                                                                    <div class="custom-control custom-control-sm custom-checkbox">
                                                                                                        <input type="checkbox" class="custom-control-input" id="empAbsent">
                                                                                                        <label class="custom-control-label" for="empAbsent">Absent</label>
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div class="col-12">
                                                ...
                                                <div class="card-search search-wrap" data-search="search">
                                                    <div class="card-body">
                                                        <div class="search-content">
                                                            ...
                                                            <input type="text" class="form-control border-transparent form-focus-none" placeholder="Search by Employee ID">
                                            ...
                                            <div class="card-inner p-0">
                                                <div class="nk-tb-list nk-tb-ulist is-compact">
                                                    <div class="nk-tb-item nk-tb-head">
                                                        ...
                                                        <div class="nk-tb-col tb-col-md"><span class="sub-text">In time</span></div>
                                                        <div class="nk-tb-col tb-col-md"><span class="sub-text">Out Time</span></div>
                                                        <div class="nk-tb-col"><span class="sub-text">Hours</span></div>
                                                                    ...
                                                                    <ul class="link-tidy sm no-bdr">
                                                                        <li>
                                                                            <div class="custom-control custom-control-sm custom-checkbox">
                                                                                ...
                                                                                <label class="custom-control-label" for="vri">Absent</label>
                                                                            </div>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                                    ...
                                                                    <div class="drodown">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-end">
                                                                            <ul class="link-list-opt no-bdr">
                                                                                ...
                                                                                <li><a data-bs-toggle="modal" href="#timeDelete"><em class="icon ni ni-delete"></em><span>Delete</span></a></li>
                                                                            </ul>
                                                                        </div>
                                                                    </div>
                                                                </li>
