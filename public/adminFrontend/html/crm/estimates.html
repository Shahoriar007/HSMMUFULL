...
<head>
    ...
    <!-- Page Title  -->
    <title>CRM | Estimates | DashLite Admin Template</title>
    <!-- StyleSheets  -->
...
<body class="nk-body bg-lighter npc-general has-sidebar ">
                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Estimates List</h3>
                                            <div class="nk-block-des text-soft">
                                                <p>You have total 95 estimates.</p>
                                            </div>
                                                            ...
                                                            <div class="drodown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end">
                                                                    <ul class="link-list-opt no-bdr">
                                                                        <li><a data-bs-toggle="modal" href="#addEstimates"><span>Add Estimates</span></a></li>
                                                                        <li><a href="#"><span>Import Estimates</span></a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </li>
                                                                                            ...
                                                                                            <div class="row gx-6 gy-3">
                                                                                                <div class="col-6">
                                                                                                    <div class="form-group">
                                                                                                        <label class="overline-title overline-title-alt">Verified</label>
                                            ...
                                            <div class="card-inner p-0">
                                                <div class="nk-tb-list nk-tb-ulist">
                                                    <div class="nk-tb-item nk-tb-head">
                                                        ...
                                                        <div class="nk-tb-col"><span class="sub-text">Created By</span></div>
                                                        ...
                                                        <div class="nk-tb-col tb-col-md"><span class="sub-text">Expires Date</span></div>
                                                        <div class="nk-tb-col tb-col-lg"><span class="sub-text">Company</span></div>
                                                        <div class="nk-tb-col tb-col-xxl"><span class="sub-text">Verified</span></div>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <span class="tb-status bg-success badge badge-dot">Accepted</span>
                                                        </div>
                                                                    ...
                                                                    <div class="drodown">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-end">
                                                                            <ul class="link-list-opt no-bdr">
                                                                                ...
                                                                                <li><a data-bs-toggle="modal" href="#editEstimates"><em class="icon ni ni-edit"></em><span>Edit</span></a></li>
                                                                                <li><a data-bs-toggle="modal" href="#deleteEstimate"><em class="icon ni ni-delete"></em><span>Delete</span></a></li>
                                                                            </ul>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name">
                                                                    <span class="tb-lead">Barry Wayne</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-xxl">
                                                        ...
                                                        <div class="nk-tb-col tb-col-xxl">
                                                            <ul class="list-status">
                                                                <li><em class="icon text-warning ni ni-alert-circle"></em> <span>Pending</span></li>
                                                            </ul>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-sm">
                                                            <span>$535.00</span>
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <span class="tb-status bg-warning badge badge-dot">Declined</span>
                                                        </div>
                                                        <div class="nk-tb-col nk-tb-col-tools">
                                                            <ul class="nk-tb-actions gx-2">
                                                                <li class="nk-tb-action-hidden">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name">
                                                                    <span class="tb-lead">Tasnim</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-xxl">
                                                        ...
                                                        <div class="nk-tb-col tb-col-xxl">
                                                            <ul class="list-status">
                                                                <li><em class="icon text-danger ni ni-alert-circle"></em> <span>Not Verified</span></li>
                                                            </ul>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-sm">
                                                            <span>$535.00</span>
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <span class="tb-status bg-danger badge badge-dot">Expired</span>
                                                        </div>
                                                        <div class="nk-tb-col nk-tb-col-tools">
                                                            <ul class="nk-tb-actions gx-2">
                                                                <li class="nk-tb-action-hidden">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name">
                                                                    <span class="tb-lead">Fuad Rahman</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-xxl">
                                                        ...
                                                        <div class="nk-tb-col tb-col-xxl">
                                                            <ul class="list-status">
                                                                <li><em class="icon text-success ni ni-alert-circle"></em> <span>Email</span></li>
                                                            </ul>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-sm">
                                                            <span>$535.00</span>
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <span class="tb-status bg-info badge badge-dot">New</span>
                                                        </div>
                                                        <div class="nk-tb-col nk-tb-col-tools">
                                                            <ul class="nk-tb-actions gx-2">
                                                                <li class="nk-tb-action-hidden">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col tb-col-md">
                                                            <span>jahangir@softnio.com</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-md">
                                                            <span>22 April 2020</span>
                                                        </div>
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <span class="tb-status bg-light badge badge-dot">Draft</span>
                                                        </div>
                                                        <div class="nk-tb-col nk-tb-col-tools">
                                                            <ul class="nk-tb-actions gx-2">
                                                                <li class="nk-tb-action-hidden">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name">
                                                                    <span class="tb-lead">Kazi Ifrat</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-xxl">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name">
                                                                    <span class="tb-lead">Leah Chatman</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-xxl">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name">
                                                                    <span class="tb-lead">Nia Matos</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-xxl">
                                                            <span>08 Feb 2020</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-md">
                                                            <span>matos@example.com</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-md">
                                                            <span>25 March 2020</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                            <span>ACS Textiles</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-xxl">
                                                            <ul class="list-status">
                                                                <li><em class="icon text-danger ni ni-alert-circle"></em> <span>Not Verified</span></li>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name">
                                                                    <span class="tb-lead">Krish Kendall</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-xxl">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col tb-col-md">
                                                            <span>larry@example.com</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-md">
                                                            <span>19 April 2020</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                            <span>Youngone Corporation</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-xxl">
                                                            <ul class="list-status">
                                                                <li><em class="icon text-success ni ni-alert-circle"></em> <span>Email</span></li>
    ...
    <!-- @@ Add Estimates Modal @@ -->
    <div class="modal fade" id="addEstimates">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body modal-body-md">
                    <h5 class="modal-title">Add Estimates</h5>
                    <form action="#" class="mt-2">
                        <div class="row g-gs">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="est-id">ID</label>
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" id="est-id" placeholder="ID" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="crea-by">Created By</label>
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" id="crea-by" placeholder="Created By" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="est-date">Date</label>
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control date-picker" id="est-date" placeholder="mm/dd/yyyy">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="est-mail">Email</label>
                                    <div class="form-control-wrap">
                                        <input type="email" class="form-control" id="est-mail" placeholder="example@example.com">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="est-exdate">Expires Date</label>
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control date-picker" id="est-exdate" placeholder="mm/dd/yyyy">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="est-company">Company</label>
                                    <div class="form-control-wrap ">
                                        <select class="form-select js-select2" id="est-company">
                                            <option value="default_option">Clinet List</option>
                                            <option value="softnio">Softnio</option>
                                            <option value="ccomics">DC Ccomics</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="est-amount">Amount</label>
                                    <div class="form-control-wrap">
                                        <input type="number" class="form-control" id="est-amount" placeholder="$">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="est-status">Status</label>
                                    <div class="form-control-wrap ">
                                        <select class="form-select js-select2" id="est-status">
                            ...
                            <div class="form-group">
                                <button type="submit" data-bs-dismiss="modal" class="btn btn-primary">Add Estimate</button>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <div class="modal fade" id="editEstimates">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <a href="#" class="close" data-bs-dismiss="modal" aria-label="Close">
                    <em class="icon ni ni-cross-sm"></em>
                        ...
                        <div class="row g-gs">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" id="edit-id" placeholder="ID" value="EST-136" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="edit-crea-by">Created By</label>
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" id="edit-crea-by" placeholder="Created By" value="Abu Bin Ishtiyak" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control date-picker" id="edit-date" placeholder="mm/dd/yyyy" value="02/10/2021">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="edit-mail">Email</label>
                                    <div class="form-control-wrap">
                                        <input type="email" class="form-control" id="edit-mail" placeholder="example@example.com" value="info@softnio.com">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="edit-exdate">Expires Date</label>
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control date-picker" id="edit-exdate" placeholder="mm/dd/yyyy" value="02/14/2021">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <select class="form-select js-select2" id="edit-company">
                                            <option value="default_option">Softnio</option>
                                            <option value="ccomics">DC Ccomics</option>
                                            <option value="runner">Runner</option>
                                        </select>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="number" class="form-control" id="edit-amount" placeholder="$" value="$535.00">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <select class="form-select js-select2" id="edit-status">
                                            <option value="default_option">Accepted</option>
                                            <option value="declined">Declined</option>
                                            <option value="expired">Expired</option>
                                        </select>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <button type="submit" data-bs-dismiss="modal" class="btn btn-primary">Update Estimate</button>
                                </div>
                            </div>
                        </div>
                    </form>
    ...
    <!-- @@ Delete Estimates Modal @@ -->
    <div class="modal fade" id="deleteEstimate">
                ...
                <div class="modal-body modal-body-sm text-center">
                    <div class="nk-modal py-4">
                        ...
                        <div class="nk-modal-text mt-n2">
                            <p class="text-soft">This Estimate data will be delete permanently.</p>
                        </div>
