...
<head>
    ...
    <!-- Page Title  -->
    <title>Dual Listbox - General | DashLite Admin Template</title>
    <!-- StyleSheets  -->
...
<body class="nk-body bg-lighter npc-general has-sidebar ">
                                ...
                                <div class="components-preview wide-md mx-auto">
                                    <div class="nk-block-head nk-block-head-lg wide-sm">
                                        <div class="nk-block-head-content">
                                            ...
                                            <h2 class="nk-block-title fw-normal">Dual Listbox</h2>
                                            <div class="nk-block-des">
                                                <p class="lead">Dual Listbox is a pure JavaScript plugin that converts the normal select box into a searchable dual list box where the users are able to move options between two selection panels.</p>
                                                <p>For more info please visit the plugin's <a href="https://github.com/maykinmedia/dual-listbox" target="_blank">GitHub.</a>.</p>
                                            </div>
                                        </div>
                                    </div><!-- .nk-block-head -->
                                    <div class="nk-block">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                ...
                                                <p>We need <code>select</code> tag with <code>multiple</code> attribute to insilize dual listbox.</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="code-block">
                                            ...
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#basicListbox" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="basicListbox">
    &lt;select id=&quot;basic-listbox&quot; class=&quot;dual-listbox&quot; multiple&gt;
      &lt;option value=&quot;1&quot;&gt;Cheese&lt;/option&gt;
      &lt;option value=&quot;2&quot;&gt;Egg&lt;/option&gt;
      &lt;option value=&quot;3&quot;&gt;Butter&lt;/option&gt;
    ...
    &lt;/select&gt;
                                    ...
                                    <div class="nk-block">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h5 class="nk-block-title">With Custom Labels</h5>
                                                <p>To set custom labels please check <a target="_blank" href="https://github.com/maykinmedia/dual-listbox#usage">this section of github page</a>. you can use html codes as value.</p>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                        ...
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#customLabelsListbox" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="customLabelsListbox">
&lt;select id=&quot;custom-labels-listbox&quot; class=&quot;dual-listbox&quot; multiple&gt;
  &lt;option value=&quot;1&quot;&gt;Cheese&lt;/option&gt;
  &lt;option value=&quot;2&quot;&gt;Egg&lt;/option&gt;
  &lt;option value=&quot;3&quot;&gt;Butter&lt;/option&gt;
...
&lt;/select&gt;
                                    ...
                                    <div class="nk-block">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h5 class="nk-block-title">Pre Selected</h5>
                                                <p>You need to use <code>selected</code> attribute in <code>option</code> tags.</p>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                        ...
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#preselectedListbox" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="preselectedListbox">
&lt;select id=&quot;preselected-listbox&quot; class=&quot;dual-listbox&quot; multiple&gt;
  &lt;option value=&quot;1&quot;&gt;Cheese&lt;/option&gt;
  &lt;option value=&quot;2&quot; selected&gt;Egg&lt;/option&gt;
  &lt;option value=&quot;3&quot;&gt;Butter&lt;/option&gt;
...
&lt;/select&gt;
                                    ...
                                    <div class="nk-block">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h5 class="nk-block-title">No Search Option</h5>
                                                <p>Please check js part of code example blew. you need to add this class <code>.dual-listbox__search--hidden</code> in search option. <br /> you can also check <a target="_blank" href="https://github.com/maykinmedia/dual-listbox#exposed-elements">this section of github page</a></p>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                        ...
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#nosearchListbox" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="nosearchListbox">
&lt;select id=&quot;nosearch-listbox&quot; data-search=&quot;false&quot; class=&quot;dual-listbox&quot; multiple&gt;
  &lt;option value=&quot;1&quot;&gt;Cheese&lt;/option&gt;
  &lt;option value=&quot;2&quot;&gt;Egg&lt;/option&gt;
  &lt;option value=&quot;3&quot;&gt;Butter&lt;/option&gt;
...
&lt;/select&gt;
                                        ...
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#nosearchListboxJs" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-js" id="nosearchListboxJs">
// JAVASCRIPT CODE
let nosearchListbox = new DualListbox('#nosearch-listbox');
    ...
    <script src="./assets/js/libs/dual-listbox.js?ver=3.1.1"></script>
    <script src="./assets/js/example-listbox.js?ver=3.1.1"></script>
</body>
