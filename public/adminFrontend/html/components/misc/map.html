...
<head>
    ...
    <!-- Page Title  -->
    <title>Google Map - General | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                                ...
                                <div class="components-preview wide-md mx-auto">
                                    <div class="nk-block-head nk-block-head-lg wide-sm">
                                        <div class="nk-block-head-content">
                                            ...
                                            <h2 class="nk-block-title fw-normal">Google Map</h2>
                                            <div class="nk-block-des">
                                                <p class="lead">Google map is using with Embed code and API Scripts</p>
                                                <p>For more info please visit <a href="https://mapsplatform.google.com/" target="_blank">Google Cloud</a>.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="nk-block">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h5 class="nk-block-title">Map with Embed</h5>
                                                <p>For using map with <strong>embed</strong> code you need to go on <a href="https://www.google.com/maps">Google Map site</a>. Set your location & take embed script for display your location.</p>
                                            </div>
                                        </div>
...
&lt;div class=&quot;card card-bordered w-100&quot;&gt;
    &lt;iframe src=&quot;https://www.google.com/maps/[Your Location]&quot; class=&quot;google-map border-0&quot; allowfullscreen=&quot;&quot; loading=&quot;lazy&quot;&gt;&lt;/iframe&gt;
&lt;/div&gt;;
</pre>
                                        </div><!-- .code-block -->
                                    </div><!-- nk-block -->
                                    <div class="nk-block">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h5 class="nk-block-title">Map with API</h5>
                                                <p>For using map with <strong>JavaScript API</strong> script you need to go on <a href="https://developers.google.com/maps/">Google Maps Platform</a>. Set your API script & added Javascript code for display your location.</p>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Use Instruction</h4>
                                                <p>As using map with <strong>API</strong> in our system you will need take additional step as below.</p>
                                                <div class="card card-preview">
                                                    <div class="card-inner">
                                                        <h6 class="overline-title">Maps Script</h6>
                                                        <p>You can simply add <code>&lt;script&gt;</code> into <code class="code-tag">&lt;body&gt;</code> tag on each page as below reference.</p>
                                                        <code class="prettyprint lang-html d-block p-2 border-0" id="uses-code"> &lt;!-- Map API Script --&gt; <br> &#x3C;script src=&#x22;https://maps.google.com/maps/api/js?key=[API key]&#x22;&#x3E;&#x3C;/script&#x3E; </code>
                                                        <div class="gap gap-gs"></div>
                                                        <h6 class="overline-title">JavaScript API Script</h6>
                                                        <p>To edit map, you will need to edit the <code>/js/example-map.js</code> file. <strong>You can follow the instruction below for edit.</strong></p>
                                                        <code class="prettyprint lang-css d-block p-2 border-0 overflow-auto" id="comiled-code"> // When the window has finished loading create our google map below <br> google.maps.event.addDomListener(window, 'load', init); <br><br> // Use function <br> // How zoomed in you want the map to start at (always required) <br> zoom: 14, <br><br> // The latitude and longitude to center the map (always required) <br> center: new google.maps.LatLng(33.4465154, -86.7318209), // New York <br><br> // Get the HTML DOM element that will contain your map <br> var mapElement = document.getElementById('gMap'); <br><br> // Markers identify locations on the map <br> // the element can be dragged <br> draggable: true, <br><br> // Clicking on the marker will toggle the animation between a BOUNCE <br> animation: google.maps.Animation.DROP <br><br> // You can use a LatLng literal in place of a google maps. <br> // LatLng object when creating the Marker object Once the Marker object is <br> // instantiated, its position will be available as a google.maps.LatLng object. <br> position: new google.maps.LatLng(33.4465154, -86.7318209), <br><br> // you can use image link into this quote <br> icon: '' // null = default icon <br>
                                                        </code>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCtOtiFYyiZeSXwiL9RS7PR8cQQXMvZNXI"></script>
    <script src="./assets/js/example-map.js?ver=3.1.1"></script>
</body>
