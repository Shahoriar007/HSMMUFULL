...
<head>
    ...
    <!-- Page Title  -->
    <title>Slick Slider - General | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                                ...
                                <div class="components-preview wide-md mx-auto">
                                    <div class="nk-block-head nk-block-head-lg wide-sm">
                                        <div class="nk-block-head-content">
                                            ...
                                            <h2 class="nk-block-title fw-normal">Slick slider</h2>
                                            <div class="nk-block-des">
                                                <p class="lead">Here is some awesome carousel and slider made with love and Slick slider. </p>
                                                <p>You can see more details from <a href="https://kenwheeler.github.io/slick/" target="_blank">here</a>.</p>
                                            </div>
                                        </div>
                                    </div><!-- .nk-block-head -->
                                    <div class="nk-block">
                                        <div class="nk-block-head wide-sm">
                                            <div class="nk-block-head-content">
                                                <h5 class="nk-block-title">Card Preview slider</h5>
                                                <p>An awesome and nice card made with slick</p>
                                            </div>
                                        </div>
...
&lt;/div&gt;
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head wide-sm">
                                            <div class="nk-block-head-content">
                                                <h5 class="nk-block-title">Pricing Table Carousel</h5>
                                                <p>A Responsive pricing table Carousel with slick.</p>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
...
&lt;/div&gt;
    ...
    <script src="./assets/js/libs/jstree.js?ver=3.1.1"></script>
    <script src="./assets/js/example-tree.js?ver=3.1.1"></script>
</body>
