...
<head>
    ...
    <!-- Page Title  -->
    <title>SVG Icons | DashLite Admin Template</title>
    <!-- StyleSheets  -->
...
<body class="nk-body bg-lighter npc-general has-sidebar ">
                                ...
                                <div class="components-preview wide-md mx-auto">
                                    <div class="nk-block">
                                        <div class="nk-block-head nk-block-head-lg wide-sm">
                                            <div class="nk-block-head-content">
                                                ...
                                                <h2 class="nk-block-title fw-normal">Custom SVG Icons</h2>
                                                <div class="nk-block-des">
                                                    <p class="lead"><strong>Softnio</strong> team design some beautiful and eyecatching custom icons that helps much in your dashboard. All the icons are in SVG format so it never blury in retina device and you can update color easily be edit SVG code.</p>
                                                </div>
                                            </div>
                                        </div><!-- .nk-block-head -->
                                        <ul class="row g-gs preview-icon-svg">
                                                ...
                                                <div class="preview-icon-box card card-bordered">
                                                    <div class="preview-icon-wrap">
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 90 90">
                                                            ...
                                                            <path d="M47,70.15S61.89,62.49,61.89,51V37.6L47,31.85,32.11,37.6V51C32.11,62.49,47,70.15,47,70.15Z" fill="#eff1ff" stroke="#6576ff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" />
                                                            <path d="M41.56,48H52.44A1.6,1.6,0,0,1,54,49.59v5.73A1.6,1.6,0,0,1,52.44,57H41.56A1.6,1.6,0,0,1,40,55.32V49.59A1.6,1.6,0,0,1,41.56,48Z" fill="#6576ff" stroke="#6576ff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" />
                                                            <path d="M43,48V45a4,4,0,0,1,8,0v3" fill="none" stroke="#6576ff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" />
                                                            <circle cx="46.67" cy="52.79" r="0.91" fill="#fff" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" />
                                                            <circle cx="23" cy="17" r="14" fill="#fff" stroke="#6576ff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" />
                                                            <circle cx="23" cy="17" r="10.5" fill="#e3e7fe" />
                                                            <path d="M28.46,20.47l-4.41-4.41a3.4,3.4,0,0,0,.26-1.31A3.34,3.34,0,1,0,21,18.1a3.41,3.41,0,0,0,1.31-.27l1.44,1.45a.33.33,0,0,0,.23.09l.79,0,0,.79a.32.32,0,0,0,.09.23.27.27,0,0,0,.23.08l.79,0,0,.79a.31.31,0,0,0,.09.22.29.29,0,0,0,.22.09l.79,0,0,.79a.3.3,0,0,0,.09.24.32.32,0,0,0,.21.08h0l1.21-.14a.3.3,0,0,0,.27-.33l-.13-1.48Z" fill="#6576ff" />
                                                            <path d="M20.56,14.09a1,1,0,0,1-1.34,0,1,1,0,0,1,0-1.35,1,1,0,1,1,1.34,1.35Z" fill="#fff" />
                                                            <path d="M23.72,16.39h0l3.79,3.79a.22.22,0,0,1,0,.32h0a.24.24,0,0,1-.32,0l-3.75-3.76Z" fill="#fff" />
                                                            <rect x="17.32" y="11.6" width="11" height="11" fill="none" />
                                                        </svg>
                                                    </div>
                                                    <span class="preview-icon-name">Account Secure</span>
                                            ...
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    ...
                                                    <span class="preview-icon-name">Bills</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    <div class="preview-icon-wrap">
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 90 90">
                                                            ...
                                                            <path d="M76.79,72.87,32.22,86.73a6,6,0,0,1-7.47-4L17,57.71A6,6,0,0,1,21,50.2L65.52,36.34a6,6,0,0,1,7.48,4l7.73,25.06A6,6,0,0,1,76.79,72.87Z" fill="#fff" stroke="#6576ff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" />
                                                            <polygon points="75.27 47.3 19.28 64.71 17.14 57.76 73.12 40.35 75.27 47.3" fill="#6576ff" />
                                                            <path d="M30,77.65l-1.9-6.79a1,1,0,0,1,.69-1.23l4.59-1.3a1,1,0,0,1,1.23.7l1.9,6.78A1,1,0,0,1,35.84,77l-4.59,1.3A1,1,0,0,1,30,77.65Z" fill="#c4cefe" />
                                                            <path d="M41.23,74.48l-1.9-6.78A1,1,0,0,1,40,66.47l4.58-1.3a1,1,0,0,1,1.23.69l1.9,6.78A1,1,0,0,1,47,73.88l-4.58,1.29A1,1,0,0,1,41.23,74.48Z" fill="#c4cefe" />
                                                            <path d="M52.43,71.32l-1.9-6.79a1,1,0,0,1,.69-1.23L55.81,62A1,1,0,0,1,57,62.7l1.9,6.78a1,1,0,0,1-.69,1.23L53.66,72A1,1,0,0,1,52.43,71.32Z" fill="#c4cefe" />
                                                            <ellipse cx="55.46" cy="19.1" rx="16.04" ry="16.1" fill="#fff" stroke="#6576ff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" />
                                                            <ellipse cx="55.46" cy="19.1" rx="12.11" ry="12.16" fill="#e3e7fe" /><text transform="translate(50.7 23.72) scale(0.99 1)" font-size="16.12" fill="#6576ff" font-family="Nunito-Black, Nunito Black">$</text>
                                                        </svg>
                                                    </div>
                                                    <span class="preview-icon-name">Card Credit</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    ...
                                                    <span class="preview-icon-name">Card Debit</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    ...
                                                    <span class="preview-icon-name">Card Secure</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    ...
                                                    <span class="preview-icon-name">Code Scan</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    ...
                                                    <span class="preview-icon-name">Codes</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    ...
                                                    <span class="preview-icon-name">Connect Secure</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    ...
                                                    <span class="preview-icon-name">Customize</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    ...
                                                    <span class="preview-icon-name">Devices</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    ...
                                                    <span class="preview-icon-name">Emails</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    ...
                                                    <span class="preview-icon-name">File Doc</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    ...
                                                    <span class="preview-icon-name">File Excel</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    ...
                                                    <span class="preview-icon-name">File Media</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                            ...
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    ...
                                                    <span class="preview-icon-name">File Word</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    <div class="preview-icon-wrap">
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 90 90">
                                                            ...
                                                            <path d="M40.73,63.77a.74.74,0,0,0-.65.81V77.19a.74.74,0,0,0,.65.81h4.05a.75.75,0,0,0,.66-.81V64.58a.75.75,0,0,0-.66-.81h-.24v2.9a1.8,1.8,0,1,1-3.57,0v-2.9Zm1.13,9.85a1.18,1.18,0,0,1,1-1.31h.69c.55,0,1,.58,1,1.31v1.17c0,.73-.44,1.31-1,1.31h-.69a1.18,1.18,0,0,1-1-1.31Z" fill="#6576ff" />
                                                            <path d="M42.76,67.57a1.39,1.39,0,0,0,1.34-1.43V61.41a1.34,1.34,0,1,0-2.68,0v4.73A1.39,1.39,0,0,0,42.76,67.57Z" fill="#6576ff" />
                                                            <path d="M43.42,54.76l3.1,0v.45c0,.55,0,1.11,0,1.68a8.6,8.6,0,0,1-.18,10.18V63.32A1.31,1.31,0,0,0,45.09,62h-.44V60.52a1.89,1.89,0,1,0-3.78,0V62h-.45a1.31,1.31,0,0,0-1.26,1.34v3.77a8.55,8.55,0,0,1,.05-10.46c0-.47,0-.94,0-1.4v-.45l3.1,0Z" fill="#6576ff" />
                                                    ...
                                                    <span class="preview-icon-name">File ZIP</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    ...
                                                    <span class="preview-icon-name">Invoice</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    ...
                                                    <span class="preview-icon-name">Loop</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    ...
                                                    <span class="preview-icon-name">Password Secure</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    ...
                                                    <span class="preview-icon-name">Profile</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    ...
                                                    <span class="preview-icon-name">Recheck</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    ...
                                                    <span class="preview-icon-name">Reports</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    ...
                                                    <span class="preview-icon-name">Settings</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                            ...
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    ...
                                                    <span class="preview-icon-name">Support Account</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    <div class="preview-icon-wrap">
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 90 90">
                                                            <path d="M63.42,87H10.58A4.08,4.08,0,0,1,6.5,82.92V7.08A4.08,4.08,0,0,1,10.58,3H48.32L67.5,21.23V82.92A4.08,4.08,0,0,1,63.42,87ZM47.5,3V16.92A4,4,0,0,0,51.38,21H66.5" fill="#fff" stroke="#6576ff" stroke-linecap="round" stroke-miterlimit="10" stroke-width="2" />
                                                    ...
                                                    <span class="preview-icon-name">Support General</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    ...
                                                    <span class="preview-icon-name">Support Payment</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    <div class="preview-icon-wrap">
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 90 90">
                                                            ...
                                                            <rect x="12" y="57.06" width="12" height="5.94" rx="1" ry="1" fill="none" stroke="#6576ff" stroke-miterlimit="10" stroke-width="2" />
                                                        </svg>
                                                    </div>
                                                    <span class="preview-icon-name">Support Secure</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    ...
                                                    <span class="preview-icon-name">sync</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    <div class="preview-icon-wrap">
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 90 90">
                                                            <path d="M81.8,22.23a2.89,2.89,0,1,1,2.89-2.89,2.89,2.89,0,0,1-2.89,2.89" fill="#e3e7fe" />
                                                            <circle cx="72.42" cy="73.31" r="2.89" fill="none" stroke="#c4cefe" stroke-linecap="round" stroke-linejoin="round" />
                                                            <path d="M15,78.12a1.93,1.93,0,1,1,1.93-1.92A1.93,1.93,0,0,1,15,78.12" fill="#e3e7fe" />
                                                            ...
                                                            <polygon points="45.52 66.59 54.28 60.59 64.72 58.64 45.52 39.44 45.52 66.59" fill="#e3e7fe" />
                                                    ...
                                                    <span class="preview-icon-name">Plan 1</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    <div class="preview-icon-wrap">
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 90 90">
                                                            <circle cx="24.83" cy="6.55" r="3.06" fill="#e3e7fe" />
                                                            <circle cx="83.97" cy="28.73" r="3.03" fill="none" stroke="#c4cefe" stroke-linecap="round" stroke-linejoin="round" />
                                                            <circle cx="83.58" cy="67.84" r="1.84" fill="#e3e7fe" />
                                                            <circle cx="12.04" cy="84.67" r="1.84" fill="#e3e7fe" />
                                                            <rect x="3" y="47.84" width="6.12" height="1.75" fill="#e3e7fe" />
                                                            <rect x="3" y="47.84" width="6.12" height="1.75" transform="translate(54.78 42.66) rotate(90)" fill="#e3e7fe" />
                                                            <circle cx="45.76" cy="64.92" r="19.82" fill="#fff" />
                                                            <circle cx="45.76" cy="64.92" r="18.24" fill="none" stroke="#6576ff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" />
                                                            <path d="M37.5,22.5V43.89a23.66,23.66,0,0,1,17,.1V22.5Z" fill="#f3f5ff" stroke="#6576ff" stroke-linecap="round" />
                                                            <path d="M20.5,22.5v23L27,51.71A23.73,23.73,0,0,1,37.5,43.89V22.5Z" fill="#e3e7fe" stroke="#6576ff" stroke-linecap="round" />
                                                            <path d="M54.5,22.5V44a23.68,23.68,0,0,1,10.32,7.86l6.68-6.37v-23Z" fill="#e3e7fe" stroke="#6576ff" stroke-linecap="round" />
                                            ...
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    ...
                                                    <span class="preview-icon-name">Plan 3</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    ...
                                                    <span class="preview-icon-name">Doc Checked</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    ...
                                                    <span class="preview-icon-name">Help/Support</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                        </ul><!-- .row -->
                                    </div>
                                    <div class="nk-block">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="nk-block-title">File Manager Icons</h4>
                                                <div class="nk-block-des">
	...
	c1.6,0,3.2,0.2,3.9,2.3l2.7,6.8c0.5,1.1,1.6,1.9,2.8,1.9h23.5c2.2,0,3.9,1.8,3.9,4v31C66,59.2,64.2,61,62.1,61z" />
                                                    ...
                                                    <span class="preview-icon-name">Folder</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    <div class="preview-icon-wrap">
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72">
                                                            <g>
                                                                ...
                                                                <path d="M8.015,59c2.169,2.3827,4.6976,2.0161,6.195,2H58.7806a6.2768,6.2768,0,0,0,5.2061-2Z" style="fill:#798bff" />
                                                    ...
                                                    <span class="preview-icon-name">Folder Secure</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    ...
                                                    <span class="preview-icon-name">Folder Shared</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    ...
                                                    <span class="preview-icon-name">Folder Alt</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    ...
                                                    <span class="preview-icon-name">Folder Secure Alt</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    ...
                                                    <span class="preview-icon-name">Folder Shared Alt</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    <div class="preview-icon-wrap">
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72">
                                                            <path d="M50,61H22a6,6,0,0,1-6-6V22l9-11H50a6,6,0,0,1,6,6V55A6,6,0,0,1,50,61Z" style="fill:#0089ff" />
                                                            <path d="M25,20.556A1.444,1.444,0,0,1,23.556,22H16l9-11h0Z" style="fill:#9bd5f9" />
                                                    ...
                                                    <span class="preview-icon-name">File Code</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                            ...
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    ...
                                                    <span class="preview-icon-name">File Movie</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    <div class="preview-icon-wrap">
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72">
                                                            <path d="M50,61H22a6,6,0,0,1-6-6V22l9-11H50a6,6,0,0,1,6,6V55A6,6,0,0,1,50,61Z" style="fill:#5a5aff" />
                                                            <path d="M25,20.556A1.444,1.444,0,0,1,23.556,22H16l9-11h0Z" style="fill:#b8b8ff" />
                                                            <path d="M44.6465,30.2373a1.006,1.006,0,0,0-.811-.2236l-12,2A1,1,0,0,0,31,33v9.5563A3.9543,3.9543,0,0,0,29,42a4,4,0,1,0,4,4V33.8467l10-1.666v8.3757A3.9543,3.9543,0,0,0,41,40a4,4,0,1,0,4,4V31A.999.999,0,0,0,44.6465,30.2373ZM29,48a2,2,0,1,1,2-2A2.0023,2.0023,0,0,1,29,48Zm12-2a2,2,0,1,1,2-2A2.0023,2.0023,0,0,1,41,46Z" style="fill:#f3f3f3" />
                                                        </svg>
                                                    </div>
                                                    <span class="preview-icon-name">File Music</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                ...
                                                <div class="preview-icon-box card card-bordered">
                                                    <div class="preview-icon-wrap">
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72">
                                                            ...
                                                            <path d="M38.14,40H33.9775a.5.5,0,1,1,0-1H38.14a.5.5,0,1,1,0,1Z" style="fill:#fff" />
                                                        </svg>
                                                    </div>
                                                    <span class="preview-icon-name">File PPT</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    ...
                                                    <span class="preview-icon-name">File Sheet</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    <div class="preview-icon-wrap">
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72">
                                                            ...
                                                            <rect x="27" y="47" width="8" height="2" rx="1" ry="1" style="fill:#fff" />
                                                        </svg>
                                                    </div>
                                                    <span class="preview-icon-name">File Text</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                            ...
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    ...
                                                    <span class="preview-icon-name">File Code Alt</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    ...
                                                    <span class="preview-icon-name">File Doc Alt</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    ...
                                                    <span class="preview-icon-name">File Media Alt</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    ...
                                                    <span class="preview-icon-name">File Movie Alt</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    <div class="preview-icon-wrap">
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72">
                                                            <g>
                                                                ...
                                                                <path d="M54,22.1111H44.1818a3.3034,3.3034,0,0,1-3.2727-3.3333V11s1.8409.2083,6.9545,4.5833C52.8409,20.0972,54,22.1111,54,22.1111Z" style="fill:#b7d0ea" />
                                                                <path d="M19.03,59A4.9835,4.9835,0,0,0,23,61H49a4.9835,4.9835,0,0,0,3.97-2Z" style="fill:#c4dbf2" />
                                                                <path d="M45.6465,30.7373a1.006,1.006,0,0,0-.811-.2236l-12,2A1,1,0,0,0,32,33.5v9.5564a3.9227,3.9227,0,0,0-3.7113-.1713,3.8628,3.8628,0,0,0-2.082,2.3135,4.0254,4.0254,0,0,0,5.3695,4.9977A3.9768,3.9768,0,0,0,34,46.4508V34.3467l10-1.666v8.3757a3.9227,3.9227,0,0,0-3.7113-.1713,3.8628,3.8628,0,0,0-2.082,2.3135,4.0254,4.0254,0,0,0,5.3695,4.9977A3.9768,3.9768,0,0,0,46,44.4508V31.5A.999.999,0,0,0,45.6465,30.7373Z" style="fill:#5a5aff" />
                                                            </g>
                                                        </svg>
                                                    </div>
                                                    <span class="preview-icon-name">File Music Alt</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    ...
                                                    <span class="preview-icon-name">File PDF Alt</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    ...
                                                    <span class="preview-icon-name">File PPT Alt</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    ...
                                                    <span class="preview-icon-name">File Sheet Alt</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    ...
                                                    <span class="preview-icon-name">File Text Alt</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                            <li class="col-lg-3 col-6 col-sm-4">
                                                <div class="preview-icon-box card card-bordered">
                                                    ...
                                                    <span class="preview-icon-name">File Zip Alt</span>
                                                </div><!-- .preview-icon-box -->
                                            </li><!-- .col -->
                                        </ul><!-- .row -->
                                    </div>
