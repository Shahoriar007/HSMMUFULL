...
<head>
    ...
    <!-- Page Title  -->
    <title>Input Group - General | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                                                ...
                                                <div class="row g-4">
                                                    <div class="col-12">
                                                        <div class="form-control-wrap">
                                                            <div class="input-group">
                                                                <div class="input-group-prepend">
                                                                    <button class="btn btn-outline-primary btn-dim dropdown-toggle" data-bs-toggle="dropdown"><span>Dropdown</span><em class="icon mx-n1 ni ni-chevron-down"></em></button>
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <div class="input-group">
                                                                <div class="input-group-prepend">
                                                                    ...
                                                                    <button class="btn btn-icon btn-outline-primary btn-dim dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown">
