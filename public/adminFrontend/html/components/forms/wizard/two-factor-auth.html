...
<head>
    ...
    <!-- Page Title  -->
    <title>Two-factor Authentication Wizard - General | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                                    ...
                                    <div class="nk-block-head nk-block-head-lg wide-sm">
                                        <div class="nk-block-head-content">
                                            ...
                                            <div class="nk-block-des">
                                                <p class="lead">We use our custom code for step by step form included in nioapp and jQuery Validation plugin for form validation.</p>
                                            </div>
                                        </div>
                                    </div><!-- .nk-block-head -->
                                                    ...
                                                    <div class="nk-stepper-content">
                                                        <div class="nk-stepper-steps stepper-steps">
                                                            <div class="nk-stepper-step">
                                                                <h5 class="title mb-3">Chooose An Authentication Options</h5>
                                                                <p>Discover how to manage Two-Factor Authentication in Dashlite. It's an additional security layer that creates a temporary, one-time password (OTP).</p>
                                                                <ul class="row g-3">
                                                                    <li class="col-6">
                                                                        <div class="custom-control custom-control-sm custom-radio pro-control custom-control-full">
                                                                            <input type="radio" class="custom-control-input" name="two-FA-method" id="two-FA-app" value="two-FA-app" required>
                                                                            <label class="custom-control-label" for="two-FA-app">
                                                                                <span class="d-flex flex-column text-center">
                                                                                    ...
                                                                                    <span class="lead-text mb-1 mt-3">Set up using an app</span>
                                                                                    <span class="sub-text">We recommend using cloud-based TOTP apps such as: 1password, authy, lastpass Authenticator or microsoft Authenticator.</span>
                                                                                </span>
                                                                            </label>
                                                                        </div>
                                                                    </li>
                                                                        ...
                                                                        <div class="custom-control custom-control-sm custom-radio pro-control custom-control-full">
                                                                            ...
                                                                            <label class="custom-control-label" for="two-FA-SMS">
                                                                                <span class="d-flex flex-column text-center">
                                                                                    ...
                                                                                    <span class="lead-text mb-1 mt-3">Set up using an SMS</span>
                                                                                    <span class="sub-text">We recommend using cloud-based TOTP apps such as: 1password, authy, lastpass Authenticator or microsoft Authenticator.</span>
                                                                                </span>
                                                                            </label>
                                                                        </div>
                                                            ...
                                                            <div class="nk-stepper-step">
                                                                <h5 class="title mb-3">Two-Factor Authenticator Apps</h5>
                                                                <p>An authenticator app lets you generate security codes on your phone without needing to receive text messages.We recommend using cloud-based TOTP apps such as: <a href="#">1password</a>, <a href="#">lastpass Authenticator</a> or <a href="#">microsoft Authenticator</a>.</p>
                                                                <div class="row g-3">
                                                                    <div class="col-12">
                                                                        <div class="d-flex">
                                                                            <div class="pe-5">
                                                                                <h6>1. Configure the app</h6>
                                                                                <p class="small">Open your two-factor authentication app and add your GitHub account by scanning the QR code to the right.</p>
                                                                                <p class="small">If you can't use a QR code, <a href="#">enter this text code.</a></p>
                                                                            </div>
                                                                            <div class="border p-1 round-lg w-150px bg-white bg-dark">
                                                                                <img src="./images/qr/qr-code.png" alt="qr-code">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-8">
                                                                        <div class="form-group">
                                                                            <label class="form-label" for="cp1-app-code">2. Enter the 6-digit code that the application generates</label>
                                                                            <div class="form-control-wrap">
                                                                                <input type="text" class="form-control" id="cp1-app-code" name="cp1-app-code" placeholder="Check your app" required>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="nk-stepper-step">
                                                                <h5 class="title mb-3">SMS: Verify Your Mobile Number</h5>
                                                                <p>Check you SMS app for 6 digit OTP</p>
                                                                <div class="row g-3">
                                                                    <div class="col-12">
                                                                        <div class="form-group">
                                                                            <label class="form-label" for="cp1-sms-code">Enter the 6-digit code from SMS</label>
                                                                            <div class="form-control-wrap">
                                                                                <input type="text" class="form-control" id="cp1-sms-code" name="cp1-sms-code" placeholder="Check your sms" required>
                                                                            </div>
                                                                            <div class="form-note">Open your two-factor authentication app and add your GitHub account by scanning the QR code to the right.</div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
