...
<head>
    ...
    <!-- Page Title  -->
    <title>Summernote Editor - General | DashLite Admin Template</title>
    <!-- StyleSheets  -->
...
<body class="nk-body bg-lighter npc-general has-sidebar ">
                                ...
                                <div class="components-preview wide-md mx-auto">
                                    <div class="nk-block-head nk-block-head-lg wide-sm">
                                        <div class="nk-block-head-content">
                                            ...
                                            <h2 class="nk-block-title fw-normal">Summernote Editor</h2>
                                            <div class="nk-block-des">
                                                <p class="lead">Using the <a href="https://summernote.org/" target="_blank">summernote</a> plugin, you can simply make some awesome rich text editor.</p>
                                            </div>
                                        </div>
                                    </div><!-- .nk-block-head -->
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Basic Editor</h4>
                                                <div class="nk-block-des">
                                                    <p>A basic demostration of Summernote rich text editor.</p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Minimal Editor</h4>
                                                <div class="nk-block-des">
                                                    <p>A minimal demostration of Summernote rich text editor.</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card card-bordered">
    ...
    <script src="./assets/js/libs/editors/summernote.js?ver=3.1.1"></script>
