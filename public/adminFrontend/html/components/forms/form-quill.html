...
<head>
    ...
    <!-- Page Title  -->
    <title>Quill Editor - General | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                                ...
                                <div class="components-preview wide-md mx-auto">
                                    <div class="nk-block-head nk-block-head-lg wide-sm">
                                        <div class="nk-block-head-content">
                                            ...
                                            <h2 class="nk-block-title fw-normal">Quill Editor</h2>
                                            <div class="nk-block-des">
                                                <p class="lead">Using the <a href="https://quilljs.com/" target="_blank">quilljs</a> plugin, you can simply make some awesome rich text editor.</p>
                                            </div>
                                        </div>
                                    </div><!-- .nk-block-head -->
