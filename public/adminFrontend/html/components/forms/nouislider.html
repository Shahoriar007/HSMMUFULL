...
<head>
    ...
    <!-- Page Title  -->
    <title>noUislider - General | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                                ...
                                <div class="components-preview wide-md mx-auto">
                                    <div class="nk-block-head nk-block-head-lg wide-sm">
                                        <div class="nk-block-head-content">
                                            ...
                                            <h2 class="nk-block-title fw-normal">noUislider</h2>
                                            <div class="nk-block-des">
                                                <p class="lead">Examples and usage guidelines for range slider with <a href="https://refreshless.com/nouislider/" target="_blank">noUislider</a> plugin.</p>
                                            </div>
                                        </div>
                                    </div><!-- .nk-block-head -->
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Basic Configuration</h4>
                                                <div class="nk-block-des">
                                                    <p>For input slider use <code>.form-control-slider</code> class on a blank div that must have an <code>id</code>.</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                <div class="row gy-4">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label class="form-label">Range Connect (upper)</label>
                                                            <div class="form-control-wrap">
                                                                <div class="form-control-slider" data-start="20" data-connect="upper" id="Range-Connect"></div>
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label class="form-label">Range Slider Step (10)</label>
                                                            <div class="form-control-wrap">
                                                                <div class="form-control-slider" data-step="10" data-start="20" id="Range-Step"></div>
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label class="form-label">Range Multiple</label>
                                                            <div class="form-control-wrap">
                                                                <div class="form-control-slider" data-connect="true" data-start="30 70" id="Range-Multiple"></div>
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                </div>
                                        ...
                                        <div class="code-block">
                                            ...
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#sliderBasic" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="sliderBasic">
&lt;div class=&quot;form-control-wrap&quot;&gt;
    &lt;div class=&quot;form-control-slider&quot; data-start=&quot;30&quot; id=&quot;Default-Range&quot;&gt;&lt;/div&gt;
&lt;/div&gt;
</pre>
                                        ...
                                        <div class="card card-bordered card-preview">
                                            <table class="table preview-reference">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><code>[data-min="0"]</code></td>
                                                        <td>Use <code>{number}</code> with <code>data-min</code> attribute for minimum value (By default its '0')</td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>[data-max="0"]</code></td>
                                                        <td>Use <code>{number}</code> with <code>data-max</code> attribute for maximum value (By default its '100')</td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>[data-start="20"]</code></td>
                                                        <td>Use <code>{number}</code> with <code>data-start</code> attribute to specify value for slider handle, this can take multiple value saparated with an space like this <code>[data-start="20 40"]</code></td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>[data-connect="lower"]</code></td>
                                                        <td>Use <code>{value}</code> with <code>data-connect</code> attribute to specify if slider handles are connected with something. you can use <code>{lower, upper, true, false}</code> with this. <code>lower</code> connects with start point, <code>upper</code> connects with end point, <code>true</code> connects handles with each other. Also you need to make combination with handle count with connect points, this can take multiple value saparated with an space like this <code>[data-connect="lower false true upper"]</code></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div><!-- .card-preview -->
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Vertical Slider</h4>
                                                <div class="nk-block-des">
                                                    <p>To make this vertical just add <code>[data-orientation="vertical"]</code> attribute on <code>.form-control-slider</code> element</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                                ...
                                                <div class="row gy-4">
                                                    <div class="col-sm-3 col-6">
                                                        <div class="form-group">
                                                            <label class="form-label">Default Range Slider</label>
                                                            <div class="form-control-wrap">
                                                                <div class="form-control-slider" data-orientation="vertical" data-start="30" id="vertical-Default-Range"></div>
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                    <div class="col-sm-3 col-6">
                                                        <div class="form-group">
                                                            <label class="form-label">Range Connect (upper)</label>
                                                            <div class="form-control-wrap">
                                                                <div class="form-control-slider" data-orientation="vertical" data-start="20" data-connect="upper" id="vertical-Range-Connect"></div>
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                    <div class="col-sm-3 col-6">
                                                        <div class="form-group">
                                                            <label class="form-label">Range Slider Step (10)</label>
                                                            <div class="form-control-wrap">
                                                                <div class="form-control-slider" data-orientation="vertical" data-step="10" data-start="20" id="vertical-Range-Step"></div>
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                    <div class="col-sm-3 col-6">
                                                        <div class="form-group">
                                                            <label class="form-label">Range Multiple</label>
                                                            <div class="form-control-wrap">
                                                                <div class="form-control-slider" data-orientation="vertical" data-connect="true" data-start="30 70" id="vertical-Range-Multiple"></div>
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                </div>
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Advanced Configuration</h4>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                <div class="row gy-4">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label class="form-label">Tooltip Slider</label>
                                                            <div class="form-control-wrap">
                                                                <div class="form-control-slider" data-tooltip="true" data-start="40" id="Tooltip-Range"></div>
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label class="form-label">Minimum Distance Slider</label>
                                                            <div class="form-control-wrap">
                                                                <div class="form-control-slider" data-tooltip="true" data-connect="true" data-start="30 60" data-min-distance="20" id="Min-Distance-Range"></div>
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label class="form-label">Maximum Distance Slider</label>
                                                            <div class="form-control-wrap">
                                                                <div class="form-control-slider" data-tooltip="true" data-connect="true" data-start="30 60" data-max-distance="50" id="Max-Distance-Range"></div>
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                </div>
                                        ...
                                        <div class="card card-bordered card-preview">
                                            <table class="table preview-reference">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><code>[data-tooltip="true"]</code></td>
                                                        <td>Use <code>{boolean}</code> with <code>data-tooltip</code> attribute to show or hide tooltip.</td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>[data-min-distance="20"]</code></td>
                                                        <td>Use <code>{number}</code> with <code>data-min-distance</code> attribute to define minimum range value, keep in mind that if you are using step value with this then this value must be dividable with step value.</td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>[data-max-distance="20"]</code></td>
                                                        <td>Use <code>{number}</code> with <code>data-max-distance</code> attribute to define maximum range value, keep in mind that if you are using step value with this then this value must be dividable with step value.</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div><!-- .card-preview -->
