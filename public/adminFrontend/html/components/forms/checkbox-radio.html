...
<head>
    ...
    <!-- Page Title  -->
    <title>Checkbox Radio - General | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                                ...
                                <div class="components-preview wide-md mx-auto">
                                    <div class="nk-block-head nk-block-head-lg wide-sm">
                                        <div class="nk-block-head-content">
                                            ...
                                            <h2 class="nk-block-title fw-normal">Checkbox &amp; Radio</h2>
                                            <div class="nk-block-des">
                                                <p class="lead">Examples and usage guidelines for .</p>
                                            </div>
                                        </div>
                                    </div><!-- .nk-block-head -->
