...
<head>
    ...
    <!-- Page Title  -->
    <title>Number Spinner - General | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                                ...
                                <div class="components-preview wide-md mx-auto">
                                    <div class="nk-block-head nk-block-head-lg wide-sm">
                                        <div class="nk-block-head-content">
                                            ...
                                            <h2 class="nk-block-title fw-normal">Number Spinner</h2>
                                            <div class="nk-block-des">
                                                <p class="lead">Examples and usage guidelines for number spinner with basic number type input.</p>
                                            </div>
                                        </div>
                                    </div><!-- .nk-block-head -->
                                        ...
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                <div class="row gy-4">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label class="form-label">Number Spinner Step (10)</label>
                                                            <div class="form-control-wrap number-spinner-wrap">
                                                                <button class="btn btn-icon btn-outline-light number-spinner-btn number-minus" data-number="minus"><em class="icon ni ni-minus"></em></button>
                                                                <input type="number" class="form-control number-spinner" placeholder="number" value="20" step="10">
                                                                <button class="btn btn-icon btn-outline-light number-spinner-btn number-plus" data-number="plus"><em class="icon ni ni-plus"></em></button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label class="form-label">Number Spinner Min Max (15 - 80)</label>
                                                            <div class="form-control-wrap number-spinner-wrap">
                                                                <button class="btn btn-icon btn-outline-light number-spinner-btn number-minus" data-number="minus"><em class="icon ni ni-minus"></em></button>
                                                                <input type="number" class="form-control number-spinner" placeholder="number" value="20" min="15" max="30">
                                                                <button class="btn btn-icon btn-outline-light number-spinner-btn number-plus" data-number="plus"><em class="icon ni ni-plus"></em></button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label class="form-label">Number Spinner with Primary Button</label>
                                                            <div class="form-control-wrap number-spinner-wrap">
