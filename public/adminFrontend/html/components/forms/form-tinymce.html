...
<head>
    ...
    <!-- Page Title  -->
    <title>Tinymce Editor - General | DashLite Admin Template</title>
    <!-- StyleSheets  -->
...
<body class="nk-body bg-lighter npc-general has-sidebar ">
                                ...
                                <div class="components-preview wide-md mx-auto">
                                    <div class="nk-block-head nk-block-head-lg wide-sm">
                                        <div class="nk-block-head-content">
                                            ...
                                            <h2 class="nk-block-title fw-normal">Tinymce Editor</h2>
                                            <div class="nk-block-des">
                                                <p class="lead">Using the <a href="https://www.tiny.cloud/" target="_blank">Tinymce</a> plugin, you can simply make some awesome rich text editor.</p>
                                            </div>
                                        </div>
                                    </div><!-- .nk-block-head -->
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Default settings Editor</h4>
                                                <div class="nk-block-des">
                                        ...
                                        <div class="card card-bordered">
                                            <div class="card-inner">
                                                <textarea class="form-control tinymce-basic">Hello, World!</textarea>
                                            </div>
                                        </div>
                                    </div><!-- .nk-block -->
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">With Menubar Editor</h4>
                                                <div class="nk-block-des">
                                        ...
                                        <div class="card card-bordered">
                                            <div class="card-inner">
                                                <textarea class="form-control tinymce-menubar">Hello, World!</textarea>
                                            </div>
                                        </div>
                                    </div><!-- .nk-block -->
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">With Toolbar Editor</h4>
                                                <div class="nk-block-des">
                                        ...
                                        <div class="card card-bordered">
                                            <div class="card-inner">
                                                <textarea class="form-control tinymce-toolbar">Hello, World!</textarea>
                                            </div>
                                        </div>
                                    </div><!-- .nk-block -->
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Inline Editor</h4>
                                                <div class="nk-block-des">
                                                    <p>just Click on the text to edit.</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card card-bordered">
                                            <div class="card-inner">
                                                <div class="tinymce-inline">
    ...
    <link rel="stylesheet" href="./assets/css/editors/tinymce.css?ver=3.1.1">
    <script src="./assets/js/libs/editors/tinymce.js?ver=3.1.1"></script>
