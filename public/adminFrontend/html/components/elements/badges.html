...
<head>
    ...
    <!-- Page Title  -->
    <title>Badges | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                                ...
                                <div class="components-preview wide-md mx-auto">
                                    <div class="nk-block-head nk-block-head-lg wide-sm">
                                        <div class="nk-block-head-content">
                                            ...
                                            <h2 class="nk-block-title fw-normal">Badges</h2>
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h5 class="title nk-block-title">Example with Variations</h5>
                                                <p>Add any of the below mentioned modifier classes to change the appearance of a badge.</p>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                <span class="preview-title overline-title">Default Style</span>
                                                ...
                                                <span class="preview-title overline-title mt-4">Pill Style</span>
                                                <ul class="preview-list">
                                                    <li class="preview-item">
                                                ...
                                                <span class="preview-title overline-title mt-4">Outline Style</span>
                                                <ul class="preview-list">
                                                    <li class="preview-item">
                                                    ...
                                                    <li class="preview-item">
                                                        <span class="badge bg-outline-gray">Gray</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge bg-outline-light">Light</span>
                                                    </li>
                                                </ul>
                                                <span class="preview-title overline-title mt-4">Outline Pill Style</span>
                                                <ul class="preview-list">
                                                    <li class="preview-item">
                                                    ...
                                                    <li class="preview-item">
                                                        <span class="badge rounded-pill bg-outline-gray">Gray</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge rounded-pill bg-outline-light">Light</span>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div><!-- .card-preview -->
                                        <div class="card card-bordered card-preview">
                                            <table class="table preview-reference">
                                                <thead class="table-light">
                                                    <tr>
                                                        <th class="overline-title w-200px">Class Reference</th>
                                                        <th class="overline-title">Details</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        <td><code>.bg-{state}</code></td>
                                                        <td>Use <code>{state}</code> as <code>primary, secondary, success, info, warning, danger, dark, gray, light</code></td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>.bg-outline-{state}</code></td>
                                                        <td>Same as above <code>{state}</code></td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>.rounded-pill</code></td>
                                                        <td><span>Use with <code>.rounded</code> class rounded badge style.</span></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div><!-- .card-preview -->
                                        <div class="code-block">
                                            ...
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#badgeBasic1" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="badgeBasic1">
...
&lt;span class=&quot;badge bg-outline-primary&quot;&gt;...&lt;/span&gt;
                                        ...
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#badgeBasic2" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="badgeBasic2">
...
&lt;span class=&quot;badge rounded-pill bg-outline-primary&quot;&gt;...&lt;/span&gt;
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h5 class="title nk-block-title">Dot Style</h5>
                                                <p>Use the <code>.badge-dot</code> modifier class to make dot style badges.</p>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                <ul class="preview-list">
                                                    <li class="preview-item">
                                                        <span class="badge badge-dot bg-primary"><span>Primary</span></span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-dot bg-secondary">Secondary</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-dot bg-success">Success</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-dot bg-danger">Danger</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-dot bg-warning">Warning</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-dot bg-info">Info</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-dot bg-dark">Dark</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-dot bg-gray">Gray</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-dot bg-light">Light</span>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div><!-- .card-preview -->
                                        <div class="code-block">
                                            ...
                                            <pre class="prettyprint lang-html" id="badgeDot1">
&lt;span class=&quot;badge badge-dot bg-primary&quot;&gt;Primary&lt;/span&gt;
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h5 class="title nk-block-title">Dim/Pale Style</h5>
                                                <p>Use the <code>.badge-dim</code> modifier class to make soft light / pale color badges.</p>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                <span class="preview-title overline-title">Pale Style</span>
                                                <ul class="preview-list">
                                                    <li class="preview-item">
                                                        <span class="badge badge-dim bg-primary">Primary</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-dim bg-secondary">Secondary</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-dim bg-success">Success</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-dim bg-danger">Danger</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-dim bg-warning">Warning</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-dim bg-info">Info</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-dim bg-dark">Dark</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-dim bg-gray">Gray</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-dim bg-light">Light</span>
                                                    </li>
                                                </ul>
                                                <span class="preview-title overline-title mt-4">Pale Pill Style</span>
                                                <ul class="preview-list">
                                                    <li class="preview-item">
                                                        <span class="badge rounded-pill badge-dim bg-primary">Primary</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge rounded-pill badge-dim bg-secondary">Secondary</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge rounded-pill badge-dim bg-success">Success</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge rounded-pill badge-dim bg-danger">Danger</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge rounded-pill badge-dim bg-warning">Warning</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge rounded-pill badge-dim bg-info">Info</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge rounded-pill badge-dim bg-dark">Dark</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge rounded-pill badge-dim bg-gray">Gray</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge rounded-pill badge-dim bg-light">Light</span>
                                                    </li>
                                                </ul>
                                                <span class="preview-title overline-title mt-4">Pale Bordered Style</span>
                                                <ul class="preview-list">
                                                    <li class="preview-item">
                                                        <span class="badge badge-dim bg-outline-primary">Primary</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-dim bg-outline-secondary">Secondary</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-dim bg-outline-success">Success</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-dim bg-outline-danger">Danger</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-dim bg-outline-warning">Warning</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-dim bg-outline-info">Info</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-dim bg-outline-dark">Dark</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-dim bg-outline-gray">Gray</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-dim bg-outline-light">Light</span>
                                                    </li>
                                                </ul>
                                                <span class="preview-title overline-title mt-4">Pale Bordered Pill Style</span>
                                                <ul class="preview-list">
                                                    <li class="preview-item">
                                                        <span class="badge rounded-pill badge-dim bg-outline-primary">Primary</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge rounded-pill badge-dim bg-outline-secondary">Secondary</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge rounded-pill badge-dim bg-outline-success">Success</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge rounded-pill badge-dim bg-outline-danger">Danger</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge rounded-pill badge-dim bg-outline-warning">Warning</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge rounded-pill badge-dim bg-outline-info">Info</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge rounded-pill badge-dim bg-outline-dark">Dark</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge rounded-pill badge-dim bg-outline-gray">Gray</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge rounded-pill badge-dim bg-outline-light">Light</span>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div><!-- .card-preview -->
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#badgePale1" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="badgePale1">
&lt;span class=&quot;badge badge-dim bg-primary&quot;&gt;Primary&lt;/span&gt;
&lt;span class=&quot;badge badge-dim rounded-pill bg-primary&quot;&gt;Primary&lt;/span&gt;
                                        ...
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#badgePale2" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="badgePale2">
&lt;span class=&quot;badge badge-dim bg-outline-primary&quot;&gt;Primary&lt;/span&gt;
&lt;span class=&quot;badge badge-dim rounded-pill bg-outline-primary&quot;&gt;Primary&lt;/span&gt;
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h5 class="title nk-block-title">Badge Size</h5>
                                                <p>Use the <code>.badge-{size}</code> modifier class to control badge sizes.</p>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                ...
                                                <ul class="preview-list">
                                                    <li class="preview-item">
                                                        <span class="badge badge-xl bg-primary">Primary</span>
                                                    </li>
                                                    <li class="preview-item">
                                                ...
                                                <ul class="preview-list">
                                                    <li class="preview-item">
                                                        <span class="badge rounded-pill badge-xl bg-primary">Primary</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge rounded-pill badge-lg bg-primary">Primary</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge rounded-pill badge-md bg-primary">Primary</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge rounded-pill badge-sm bg-primary">Primary</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge rounded-pill bg-primary">Primary</span>
                                                    </li>
                                        ...
                                        <div class="card card-bordered card-preview">
                                            <table class="table preview-reference">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><code>.badge-{size}</code></td>
                                                        <td>Use <code>{size}</code> as <code>sm, md, lg, xl</code></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div><!-- .card-preview -->
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#badgeSize1" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="badgeSize1">
&lt;span class=&quot;badge badge-md bg-primary&quot;&gt;Primary&lt;/span&gt;
</pre>
                                        </div><!-- .code-block -->
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#badgeSize2" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="badgeSize2">
&lt;span class=&quot;badge rounded-pill badge-md bg-primary&quot;&gt;Primary&lt;/span&gt;
</pre>
                                        </div><!-- .code-block -->
                                    </div>
