...
<head>
    ...
    <!-- Page Title  -->
    <title>Embeds | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                                ...
                                <div class="components-preview wide-md mx-auto">
                                    <div class="nk-block-head nk-block-head-lg wide-sm">
                                        <div class="nk-block-head-content">
                                            ...
                                            <h2 class="nk-block-title fw-normal">Media Embeds</h2>
                                            <div class="nk-block-des">
                                                <p class="lead">Create responsive video or slideshow embeds based on the width of the parent by creating an intrinsic ratio that scales on any device.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Example</h4>
                                                <p>Wrap any embed like an <code>&lt;iframe&gt;</code> in a parent element with <code>.ratio</code> and an aspect ratio. <br>The <code>.ratio-item</code> isn’t strictly required, but we encourage it.</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="code-block">
                                            ...
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#Embeded1" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="Embeded1">
&lt;div class=&quot;ratio&quot;&gt;
...
&lt;/div&gt;
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Aspect Eatios</h4>
                                                <p>Aspect ratios can be customized with modifier classes. By default the following ratio classes are available.</p>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
