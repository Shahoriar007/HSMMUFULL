...
<head>
    ...
    <!-- Page Title  -->
    <title>Avatar | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                                ...
                                <div class="components-preview wide-md mx-auto">
                                    <div class="nk-block-head nk-block-head-lg wide-sm">
                                        <div class="nk-block-head-content">
                                            ...
                                            <h2 class="nk-block-title fw-normal">Avatar</h2>
                                            <div class="nk-block-des">
                                                <p class="lead">Documentation and examples for avatars.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                ...
                                                <p>Add any of the below mentioned modifier classes to change the appearance of a avatar.</p>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                <div class="row g-4">
                                                    <div class="col-md-3">
                                                        <span class="preview-title overline-title">Default Style's</span>
                                                    ...
                                                    <div class="col-md-3">
                                                        <span class="preview-title overline-title">Status Style's</span>
                                                        <ul class="preview-list g-2">
                                                            <li class="preview-item">
                                                                <div class="user-avatar">
                                                                    <span>AB</span>
                                                    ...
                                                    <div class="col-md-3">
                                                        <span class="preview-title overline-title">Square Style's</span>
                                                        <ul class="preview-list g-2">
                                                            <li class="preview-item">
                                                    ...
                                                    <div class="col-md-3">
                                                        <span class="preview-title overline-title">Group Style's</span>
                                                        <ul class="preview-list g-2">
                                                            <li class="preview-item">
                                                    ...
                                                    <div class="col-md-3">
                                                        <span class="preview-title overline-title">Group Style's v2</span>
                                                        <ul class="preview-list g-2">
                                                            <li class="preview-item">
                                        ...
                                        <div class="code-block">
                                            ...
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#avatarbasic" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="avatarbasic">
...
&lt;/div&gt;
                                        ...
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#avatarStatus" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="avatarStatus">
...
&lt;/div&gt;
                                        ...
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#avatarSquared" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="avatarSquared">
...
&lt;/div&gt;
                                        ...
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#avatarV1" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="avatarV1">
...
&lt;/div&gt;
                                        ...
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#avatarV2" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="avatarV2">
...
&lt;/div&gt;
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h5 class="title nk-block-title">Example with Color Variations</h5>
                                                <p>Add any of the below mentioned modifier classes to change the appearance of a avatar.</p>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                <div class="row g-4">
                                                    <div class="col-12">
                                                        <span class="preview-title overline-title">Avatar Fill Color</span>
                                                        <ul class="preview-list g-2">
                                                            <li class="preview-item">
                                                    ...
                                                    <div class="col-12">
                                                        <span class="preview-title overline-title">Avatar Dim Color</span>
                                                        <ul class="preview-list g-2">
                                                            <li class="preview-item">
                                                            ...
                                                            <li class="preview-item">
                                                                <div class="user-avatar bg-secondary-dim">
                                                                    <span>NL</span>
                                                                </div>
                                                            </li>
                                                            <li class="preview-item">
                                                            ...
                                                            <li class="preview-item">
                                                                <div class="user-avatar bg-azure-dim">
                                                                    <span>DM</span>
                                                                </div>
                                                            </li>
                                                            <li class="preview-item">
                                                            ...
                                                            <li class="preview-item">
                                                                <div class="user-avatar bg-gray-dim">
                                                                    <span>VA</span>
                                                                </div>
                                                            </li>
                                                            <li class="preview-item">
                                            ...
                                            <table class="table preview-reference">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>Use <code>{color}</code> as <code>primary, secondary, warning, danger, success, info, azure, blue, pink, indigo, dark, gray, orange, teal, purple, lighter</code></td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>.bg-{color}-dim</code></td>
                                                        <td>Use <code>{color}</code> as <code>primary, secondary, warning, danger, success, info, azure, blue, pink, indigo, dark, gray, orange, teal, purple, light</code> <br> Use <code>light</code> without <code>-dim</code> postfix</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div><!-- .card-preview -->
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h5 class="title nk-block-title">Example with Sizes</h5>
                                                <p>Add any of the below mentioned modifier classes to change the appearance of a avatar.</p>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                <div class="row g-4">
                                                    <div class="col-md-6">
                                                        <span class="preview-title overline-title">Rounded Avatars</span>
                                                        <ul class="preview-list g-2">
                                                            <li class="preview-item">
                                                    ...
                                                    <div class="col-md-6">
                                                        <span class="preview-title overline-title">Squared Avatars</span>
                                                        <ul class="preview-list g-2">
                                                            <li class="preview-item">
                                                            ...
                                                            <li class="preview-item">
                                                                <div class="user-avatar sq sm">
                                                                    <span>AB</span>
                                                                </div>
                                                            </li>
                                                            <li class="preview-item">
                                                                <div class="user-avatar sq xs">
                                                                    <span>A</span>
                                                                </div>
                                                            </li>
                                                        </ul>
                                            ...
                                            <table class="table preview-reference">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>Use <code>{size}</code> as <code>xl, lg, md, sm, xs</code></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div><!-- .card-preview -->
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h5 class="title nk-block-title">Example with Use Case</h5>
                                            ...
                                            <div class="card-inner">
                                                <div class="row g-4">
                                                    <div class="col-md-4 col-sm-6">
                                                        <span class="preview-title overline-title">User Card 1</span>
                                                        <div class="user-toggle">
                                                            <div class="user-avatar">
                                                                <em class="icon ni ni-user-alt"></em>
                                                            </div>
                                                    ...
                                                    <div class="col-md-4 col-sm-6">
                                                        <span class="preview-title overline-title">User Card 2</span>
                                                        <div class="user-card">
                                                            <div class="user-avatar">
                                                                <img src="./images/avatar/c-sm.jpg" alt="">
                                                            </div>
                                                    ...
                                                    <div class="col-md-4 col-sm-6">
                                                        <span class="preview-title overline-title">User Card 3</span>
                                                        <div class="user-card">
                                        ...
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#avatarUserCard1" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="avatarUserCard1">
...
&lt;/div&gt;
                                        ...
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#avatarUserCard2" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="avatarUserCard2">
...
&lt;/div&gt;
                                        ...
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#avatarUserCard3" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="avatarUserCard3">
