...
<head>
    ...
    <!-- Page Title  -->
    <title>Display Utility | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                                ...
                                <div class="components-preview wide-md mx-auto">
                                    <div class="nk-block-head nk-block-head-lg wide-sm">
                                        <div class="nk-block-head-content">
                                            ...
                                            <h2 class="nk-block-title fw-normal">Display Utility</h2>
                                            <div class="nk-block-des">
                                                <p class="lead">Quickly and responsively toggle the display value of components and more with our display utilities. Classes can be combined for various effects as you need.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Basic Uses</h4>
                                                <div class="nk-block-des">
                                                    <p>These utilities classes allow to set display property of an element.</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                            <table class="table preview-reference">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><code>.d-{breakpoint}-{name}</code></td>
                                                        <td>Use <code>{breakpoint}</code> as <code>sm, md, lg, and xl</code> to effect on screen width.</td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2">
                                                            <em class="fs-13px">The media queries effect screen widths with the given breakpoint or larger. For example, <code>.d-lg-none</code> sets <code class="code-fnc">display: none;</code> on both <code>lg</code> and <code>xl</code> screens.</em>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
...
&lt;div class=&quot;d-block&quot;&gt; ... &lt;/div&gt;
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Hiding elements</h4>
                                                <div class="nk-block-des">
                                                    <p>For faster mobile-friendly development, use responsive display classes for showing and hiding elements by device.</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                            <table class="table preview-reference">
                                                <thead class="table-light">
                                                    <tr>
                                                        <th class="overline-title w-35">Class Reference</th>
                                                        <th class="overline-title ">Screen Size</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
