...
<head>
    ...
    <!-- Page Title  -->
    <title>Sizing Utility | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                                ...
                                <div class="components-preview wide-md mx-auto">
                                    <div class="nk-block-head nk-block-head-lg wide-sm">
                                        <div class="nk-block-head-content">
                                            ...
                                            <h2 class="nk-block-title fw-normal">Sizing Utility</h2>
                                            <div class="nk-block-des">
                                                <p class="lead">Easily make an element as wide or as tall with our width and height utilities.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Set a Width</h4>
                                                <div class="nk-block-des">
                                                    <p>These utility classes allow to set width of an element instantly.</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card card-bordered card-preview">
                                            <table class="table preview-reference">
                                                <thead class="table-light">
                                                    <tr>
                                                        <th class="overline-title w-200px">Percent Width</th>
                                        ...
                                        <div class="card card-bordered card-preview">
                                            <table class="table preview-reference">
                                                <thead class="table-light">
                                                    <tr>
                                                        <th class="overline-title w-200px">Use-case Width</th>
                                                        <th class="overline-title">Value</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        <td><code>.wide-{value}</code></td>
                                                        <td>xs | sm | md | lg | xl</td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2">
                                                            <em class="fs-13px">These classes mostly used with <code>.container</code> to specific width on any larger screens.</em>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        <div class="card card-bordered card-preview">
                                            <table class="table preview-reference">
                                                <thead class="table-light">
                                                    <tr>
                                                        <th class="overline-title w-200px">Specific Width</th>
                                                        <th class="overline-title">Value</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        <td><code>.w-{value}</code></td>
                                                        <td>80px | 90px | 100px | 110px | 120px | 125px | 130px | 140px | 150px | 175px | 200px | 220px | 225px | 250px | 300px | 350px | 400px | 550px</td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>.w-max-{value}</code></td>
                                                        <td><span class="text-soft">Same as above</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>.w-min-{value}</code></td>
                                                        <td><span class="text-soft">Same as above</span></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        <div class="card card-bordered card-preview">
                                            <table class="table preview-reference">
                                                <thead class="table-light">
                                                    <tr>
                                                        <th class="overline-title w-200px">Full Width</th>
                                                        <th class="overline-title">Value</th>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><code>.w-{value}</code></td>
                                                        <td>auto | 100</td>
                                                        <td><em class="text-soft"><code>auto</code> use for reset</em></td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>.w-max-{value}</code></td>
                                                        <td>auto | 100</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> </td>
                                                        <td><em class="text-soft">Same as <code>.w-max-100</code></em></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div><!-- .card-preview -->
...
&lt;div class=&quot;w-min-100px&quot;&gt; ... &lt;/div&gt;
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Set a Height</h4>
                                                <div class="nk-block-des">
                                                    <p>These utility classes allow to set width of an element instantly.</p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                <div class="d-flex example-height">
                                        ...
                                        <div class="card card-bordered card-preview">
                                            <table class="table preview-reference">
                                                <thead class="table-light">
                                                    <tr>
                                                        <th class="overline-title w-200px">Percent Height</th>
                                                        <th class="overline-title">Value</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><em class="text-soft">Set max height 100%</em></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div><!-- .card-preview -->
                                        <div class="card card-bordered card-preview">
                                            <table class="table preview-reference">
                                                <thead class="table-light">
                                                    <tr>
                                                        <th class="overline-title w-200px">Specific Height</th>
                                                        <th class="overline-title">Value</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        <td><code>.h-{value}</code></td>
                                                        <td>100px | 150px | 175px | 200px | 225px | 250px | 275px | 300px | 325px | 350px | 375px | 400px | 425px | 450px | 475px | 500px</td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>.h-max-{value}</code></td>
                                                        <td><span class="text-soft">Same as above</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>.h-min-{value}</code></td>
                                                        <td><span class="text-soft">Same as above</span></td>
                                                    </tr>
                                                </tbody>
                                            </table>
...
&lt;div class=&quot;h-min-325px&quot;&gt; ... &lt;/div&gt;
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Relative to the viewport</h4>
                                                <div class="nk-block-des">
