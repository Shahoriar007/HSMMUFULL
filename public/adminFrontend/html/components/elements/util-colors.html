...
<head>
    ...
    <!-- Page Title  -->
    <title>Color Utility | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                                ...
                                <div class="components-preview wide-md mx-auto">
                                    <div class="nk-block-head nk-block-head-lg wide-sm">
                                        <div class="nk-block-head-content">
                                            ...
                                            <h2 class="title nk-block-title fw-normal">Color Utility</h2>
                                            <div class="nk-block-des">
                                                <p class="lead">Convey meaning through color with a handful of color utility classes. This utilities to quickly style the text and background of any element.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Background Color</h4>
                                                <div class="nk-block-des">
                                                    <p>A set of solid background utilities classes. Use <code class="code-class">.bg-{color}</code> classs in element to set background color.</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                ...
                                                <div class="d-flex flex-wrap bg-white text-center fs-12px">
                                                    <div class="w-80px flex-fill p-2 bg-primary text-white">primary</div>
                                                    <div class="w-80px flex-fill p-2 bg-secondary text-white">secondary</div>
                                                    <div class="w-80px flex-fill p-2 bg-dark text-white">dark</div>
                                                    <div class="w-80px flex-fill p-2 bg-gray text-white">gray</div>
                                                    <div class="w-80px flex-fill p-2 bg-success text-white">success</div>
                                                    <div class="w-80px flex-fill p-2 bg-danger text-white">danger</div>
                                                    <div class="w-80px flex-fill p-2 bg-warning text-dark">warning</div>
                                                    <div class="w-80px flex-fill p-2 bg-info text-white">info</div>
                                                </div>
                                                <h5 class="overline-title mt-4">Theme Pale Color</h5>
                                                <div class="d-flex flex-wrap bg-white text-center fs-12px">
                                                    <div class="w-80px flex-fill p-2 bg-primary-dim text-primary">primary</div>
                                                    <div class="w-80px flex-fill p-2 bg-secondary-dim text-secondary">secondary</div>
                                                    ...
                                                    <div class="w-80px flex-fill p-2 bg-success-dim text-success">success</div>
                                                    <div class="w-80px flex-fill p-2 bg-danger-dim text-danger">danger</div>
                                                    <div class="w-80px flex-fill p-2 bg-warning-dim text-warning">warning</div>
                                                    <div class="w-80px flex-fill p-2 bg-info-dim text-info">info</div>
                                                </div>
                                        ...
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                <h5 class="overline-title">Additional Color</h5>
                                                <div class="d-flex flex-wrap bg-white text-center fs-12px">
                                                    ...
                                                    <div class="w-80px flex-fill p-2 bg-purple text-white">purple</div>
                                                ...
                                                <h5 class="overline-title mt-4">Additional Pale Color</h5>
                                                <div class="d-flex flex-wrap bg-white text-center fs-12px">
                                                    ...
                                                    <div class="w-80px flex-fill p-2 bg-purple-dim text-purple">purple</div>
                                            ...
                                            <table class="table preview-reference">
                                                <thead class="table-light">
                                                    <tr>
                                                        ...
                                                        <th class="overline-title ">Theme/Color</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <code>.bg-{theme}</code><br>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>Use for pale/dim color and <span class="text-soft"><code>{theme}</code> same as above</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <code>.bg-{color}</code>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>Use for pale/dim color and <span class="text-soft"><code>{color}</code> same as above</span></td>
                                                    </tr>
                                                    <tr>
                                        ...
                                        <div class="code-block code-block-clean">
                                            <span class="title">Uses Example</span>
...
&lt;div class=&quot;bg-primary is-dim&quot;&gt; ... &lt;/div&gt;
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Gray & Dark Color</h4>
                                                <div class="nk-block-des">
                                                    <p>A set of shade color of gray and dark classes. Use <code class="code-class">.bg-gray-{value}</code> classs in element to set background color.</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                <div class="d-flex flex-wrap bg-white text-center fs-12px">
                                                    <div class="w-80px flex-fill p-2 bg-gray-100 text-dark">100</div>
                                                    <div class="w-80px flex-fill p-2 bg-gray-200 text-dark">200</div>
                                                    <div class="w-80px flex-fill p-2 bg-gray-300 text-dark">300</div>
                                                    <div class="w-80px flex-fill p-2 bg-gray-400 text-dark">400</div>
                                                    <div class="w-80px flex-fill p-2 bg-gray-500 text-white">500</div>
                                                    <div class="w-80px flex-fill p-2 bg-gray-600 text-white">600</div>
                                                    <div class="w-80px flex-fill p-2 bg-gray-700 text-white">700</div>
                                                    <div class="w-80px flex-fill p-2 bg-gray-800 text-white">800</div>
                                                    <div class="w-80px flex-fill p-2 bg-gray-900 text-white">900</div>
                                                </div>
                                            </div>
                                        </div><!-- .card-preview -->
                                        <div class="card card-bordered card-preview">
                                            <table class="table preview-reference">
                                                <thead class="table-light">
                                                    <tr>
                                                        <th class="overline-title w-200px">Class Reference</th>
                                                        <th class="overline-title ">Value</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        <td><code>.bg-gray-{value}</code></td>
...
&lt;div class=&quot;bg-gray-200&quot;&gt; ... &lt;/div&gt;
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Text Color</h4>
                                                <p>A set of text color utilities classes. Use <code class="code-class">.text-{theme|color}</code> classs in element to set text color.</p>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                            <table class="table preview-reference">
                                                <thead class="table-light">
                                                    <tr>
                                                        ...
                                                        <th class="overline-title">Preview</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        <td><code>.text-primary</code></td>
                                                        <td><span class="text-primary">Text in primary color</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>.text-secondary</code></td>
                                                        <td><span class="text-secondary">Text in secondary color</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>.text-success</code></td>
                                                        <td><span class="text-success">Text in success color</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>.text-danger</code></td>
                                                        <td><span class="text-danger">Text in danger color</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>.text-warning</code></td>
                                                        <td><span class="text-warning">Text in warning color</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>.text-info</code></td>
                                                        <td><span class="text-info">Text in info color</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>.text-body</code></td>
                                                        <td><span class="text-body">Text in body color</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>.text-dark</code></td>
                                                        <td><span class="text-dark">Text in dark color</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>.text-base</code></td>
                                                        <td><span class="text-base">Text in base color</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>.text-soft</code></td>
                                                        <td><span class="text-soft">Text in soft color</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>.text-black-50</code></td>
                                                        <td><span class="text-black-50">Text in black 50% color</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>.text-light</code></td>
                                                        <td><span class="text-light bg-dark">Text in light color</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>.text-lighter</code></td>
                                                        <td><span class="text-lighter bg-dark">Text in lighter color</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>.text-white</code></td>
                                                        <td><span class="text-white bg-dark">Text in white color</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <code>.text-{theme}</code><br>
                                                            <code>.text-{theme}-dim</code>
                                                        </td>
                                                        <td> Use for text color &amp; <code>-dim</code> user for pale color. <br>
                                                            <span class="text-soft"><code>{theme}</code> use as <code>primary, secondary, success, info, warning, danger, dark, gray</code></span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td> Use for text color &amp; <code>-dim</code> user for pale color.<br>
                                                            <span class="text-soft"><code>{color}</code> use as <code>blue, azure, indigo, purple, pink, orange, teal</code></span>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
