...
<head>
    ...
    <!-- Page Title  -->
    <title>List Dropdown | DashLite Admin Template</title>
    <!-- StyleSheets  -->
...
<body class="nk-body bg-lighter npc-general has-sidebar ">
                                ...
                                <div class="components-preview wide-md mx-auto">
                                    <div class="nk-block-head nk-block-head-lg wide-sm">
                                        <div class="nk-block-head-content">
                                            ...
                                            <h2 class="nk-block-title fw-normal">List Style for Dropdown</h2>
                                            <div class="nk-block-des">
                                                <p class="lead">Toggle contextual overlays for displaying lists of links and more with the Bootstrap dropdown plugin. Our exclusive link list style for dropdown that give you more power.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h5 class="title nk-block-title">Dropdown Style</h5>
                                                <p>Use <code>.link-check</code> class on <code>ul</code> to get styles shown in card below.</p>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card-inner">
                                                <ul class="preview-list">
                                                    <li class="preview-item">
                                                        <div class="dropdown">
                                                            <a class="btn btn-primary dropdown-toggle" href="#" data-bs-toggle="dropdown">Dropdown button</a>
                                                    ...
                                                    <li class="preview-item">
                                                        <div class="dropup">
                                                            <a class="btn btn-primary dropdown-toggle" href="#" data-bs-toggle="dropdown">Dropup Button</a>
                                                            <div class="dropdown-menu">
                                                                <ul class="link-list-opt">
                                                                    <li><a href="#"><span>Profile Settings</span></a></li>
                                                                    <li><a href="#"><span>Notification</span></a></li>
                                                    ...
                                                    <li class="preview-item">
                                                        <div class="btn-group dropup">
                                                            <button type="button" class="btn btn-secondary">Action</button>
                                                            <button type="button" class="btn btn-secondary dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown">
                                                                <em class="icon ni ni-chevron-up"></em><span class="visually-hidden">Toggle Dropup</span>
                                                            </button>
                                                            <div class="dropdown-menu">
                                                                <ul class="link-list-opt no-bdr">
                                                                    <li><a href="#"><span>Profile Settings</span></a></li>
                                                    ...
                                                    <li class="preview-item">
                                                        <div class="dropright">
                                                            <a class="btn btn-primary dropdown-toggle" href="#" data-bs-toggle="dropdown">Dropright Button</a>
                                                            <div class="dropdown-menu">
                                                                <ul class="link-list-opt">
                                                                    <li><a href="#"><span>Profile Settings</span></a></li>
                                                                    <li><a href="#"><span>Notification</span></a></li>
                                                    ...
                                                    <li class="preview-item">
                                                        <div class="btn-group dropright">
                                                            <button type="button" class="btn btn-secondary">Action</button>
                                                            <button type="button" class="btn btn-secondary dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown">
                                                                <em class="icon ni ni-chevron-right"></em><span class="visually-hidden">Toggle Dropright</span>
                                                            </button>
                                                            <div class="dropdown-menu">
                                                                <ul class="link-list-opt no-bdr">
                                                                    <li><a href="#"><span>Profile Settings</span></a></li>
                                        ...
                                        <div class="code-block">
                                            ...
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#linkCheck1" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="linkCheck1">
    &lt;div class=&quot;dropdown&quot;&gt;
    ...
    &lt;/div&gt;
                                            ...
                                            <table class="table preview-reference">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>Trigger dropdown menus above elements by adding <code>.dropup</code> to the parent element.</td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>.dropright</code>, <code>.dropleft</code></td>
                                                        <td>Trigger dropdown menus at the right/left of the elements by adding <code>.dropright|.dropleft</code> to the parent element.</td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>.dropdown-menu-end</code></td>
                                                        <td>Add <code>.dropdown-menu-end</code> to a <code>.dropdown-menu</code> to right align the dropdown menu.<br>
                                                            <em>Note: By default, a dropdown menu is automatically positioned 100% from the top and along the left side of its parent.</em>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>.dropdown-menu-{size}</code></td>
                                                        <td>Use <code>{size}</code> as <code>xl, lg, md, sm, xs, xxs</code> to <code>.dropdown-menu</code> for controling the width.</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div><!-- .card-preview -->
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h5 class="title nk-block-title">Example 1 - Option Style</h5>
                                                <p>Use <code>.link-list-opt</code> class on <code>ul</code> to get styles shown in card below.</p>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                <h6 class="title mb-3">With Border</h6>
                                                <ul class="preview-list">
                                                    <li class="preview-item">
                                                        ...
                                                        <div class="dropdown-preview">
                                                            <div class="dropdown-menu">
                                                                <ul class="link-list-opt">
                                                                    ...
                                                                    <li><a href="#"><span>Another Action</span></a></li>
                                                                    <li><a href="#"><span>More Action</span></a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </li><!-- li -->
                                                    <li class="preview-item">
                                                        <span class="preview-title overline-title">Selected / Actived</span>
                                                        <div class="dropdown-preview">
                                                            <div class="dropdown-menu">
                                                                <ul class="link-list-opt">
                                                                    <li><a href="#"><span>List Action</span></a></li>
                                                                    <li class="active"><a href="#"><span>Another Action</span></a></li>
                                                                    <li><a href="#"><span>More Action</span></a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <li class="preview-item">
                                                        <span class="preview-title overline-title">With Icon</span>
                                                        <div class="dropdown-preview">
                                                            <div class="dropdown-menu">
                                                                <ul class="link-list-opt">
                                                    ...
                                                    <li class="preview-item">
                                                        <span class="preview-title overline-title">Preview</span>
                                                        <ul class="d-flex g-3">
                                                            <li>
                                                                <div class="dropdown">
                                                                    <a href="#" class="dropdown-toggle btn btn-light" data-bs-toggle="dropdown">Click Here</a>
                                                                    <div class="dropdown-menu">
                                                                        <ul class="link-list-opt">
                                                                            <li><a href="#"><em class="icon ni ni-setting"></em><span>Action Settings</span></a></li>
                                                                            <li><a href="#"><em class="icon ni ni-notify"></em><span>Push Notification</span></a></li>
                                        ...
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#linkListOpt1" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="linkListOpt1">
    &lt;ul class=&quot;link-list-opt&quot;&gt;
    ...
    &lt;/ul&gt;
                                        ...
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                <h6 class="title mb-3">Without Border</h6>
                                                <ul class="preview-list">
                                                    <li class="preview-item">
                                                        <span class="preview-title overline-title">Default</span>
                                                        <div class="dropdown-preview">
                                        ...
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#linkListOpt2" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="linkListOpt2">
    &lt;ul class=&quot;link-list-opt no-bdr&quot;&gt;
        &lt;li&gt;&lt;a href=&quot;#&quot;&gt;&lt;em class=&quot;icon ni ni-setting&quot;&gt;&lt;/em&gt;&lt;span&gt;List Action&lt;/span&gt;&lt;/a&gt;&lt;/li&gt;
        &lt;li&gt;&lt;a href=&quot;#&quot;&gt;&lt;em class=&quot;icon ni ni-notify&quot;&gt;&lt;/em&gt;&lt;span&gt;Another Action&lt;/span&gt;&lt;/a&gt;&lt;/li&gt;
        &lt;li&gt;&lt;a href=&quot;#&quot;&gt;&lt;em class=&quot;icon ni ni-activity-alt&quot;&gt;&lt;/em&gt;&lt;span&gt;More Action&lt;/span&gt;&lt;/a&gt;&lt;/li&gt;
    &lt;/ul&gt;
                                        ...
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                <h6 class="title mb-3">With Separator</h6>
                                                <ul class="preview-list">
                                                    <li class="preview-item">
                                                        <span class="preview-title overline-title">Default</span>
                                                        <div class="dropdown-preview">
                                                            <div class="dropdown-menu">
                                                                <ul class="link-list-opt no-bdr">
                                                                    ...
                                                                    <li><a href="#"><span>Another Action</span></a></li>
                                                                    <li class="divider"></li>
                                                                    <li><a href="#"><span>More Action Link</span></a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </li><!-- li -->
                                        ...
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#linkListOpt3" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="linkListOpt3">
    &lt;ul class=&quot;link-list-opt no-bdr&quot;&gt;
        &lt;li&gt;&lt;a href=&quot;#&quot;&gt;&lt;em class=&quot;icon ni ni-setting&quot;&gt;&lt;/em&gt;&lt;span&gt;Action Settings&lt;/span&gt;&lt;/a&gt;&lt;/li&gt;
        &lt;li&gt;&lt;a href=&quot;#&quot;&gt;&lt;em class=&quot;icon ni ni-notify&quot;&gt;&lt;/em&gt;&lt;span&gt;Push Notification&lt;/span&gt;&lt;/a&gt;&lt;/li&gt;
        &lt;li class=&quot;divider&quot;&gt;&lt;/li&gt;
    ...
    &lt;/ul&gt;
                                            ...
                                            <table class="table preview-reference">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>Use <code>active</code> class with <code>a</code> tag for active style</td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>.no-bdr</code></td>
                                                        <td>Use <code>no-bdr</code> class with <code>ul</code> tag for borderless list style</td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>.divider</code></td>
                                                        <td>Use <code>divider</code> class with blank <code>li</code> tag to get a divider.</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div><!-- .card-preview -->
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h5 class="title nk-block-title">Example 2 - Plain Style</h5>
                                                <p>Use <code>.link-list-plain</code> class on <code>ul</code> to get styles shown in card below.</p>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                ...
                                                <ul class="preview-list">
                                                        ...
                                                        <div class="dropdown-preview">
                                                            <div class="dropdown-menu">
                                                                <ul class="link-list-plain">
                                                                    <li><a href="#"><span>Action Settings</span></a></li>
                                                                    <li><a href="#"><span>Push Notification</span></a></li>
                                                                    <li><a href="#"><span>Login Activity</span></a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </li><!-- li -->
                                                    ...
                                                    <li class="preview-item">
                                                        <span class="preview-title overline-title">Compact / Small</span>
                                                        <div class="dropdown-preview">
                                                            <div class="dropdown-menu">
                                        ...
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#linkListPlain1" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="linkListPlain1">
    &lt;ul class=&quot;link-list-plain&quot;&gt;
        &lt;li&gt;&lt;a href=&quot;#&quot;&gt;&lt;em class=&quot;icon ni ni-setting&quot;&gt;&lt;/em&gt;&lt;span&gt;Action Settings&lt;/span&gt;&lt;/a&gt;&lt;/li&gt;
        &lt;li&gt;&lt;a href=&quot;#&quot;&gt;&lt;em class=&quot;icon ni ni-notify&quot;&gt;&lt;/em&gt;&lt;span&gt;Push Notification&lt;/span&gt;&lt;/a&gt;&lt;/li&gt;
        &lt;li&gt;&lt;a href=&quot;#&quot;&gt;&lt;em class=&quot;icon ni ni-activity-alt&quot;&gt;&lt;/em&gt;&lt;span&gt;Login Activity&lt;/span&gt;&lt;/a&gt;&lt;/li&gt;
    &lt;/ul&gt;
                                        ...
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#linkListPlain2" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="linkListPlain2">
    &lt;ul class=&quot;link-list-plain no-bdr&quot;&gt;
        &lt;li&gt;&lt;a href=&quot;#&quot;&gt;&lt;em class=&quot;icon ni ni-setting&quot;&gt;&lt;/em&gt;&lt;span&gt;Action Settings&lt;/span&gt;&lt;/a&gt;&lt;/li&gt;
        &lt;li&gt;&lt;a href=&quot;#&quot;&gt;&lt;em class=&quot;icon ni ni-notify&quot;&gt;&lt;/em&gt;&lt;span&gt;Push Notification&lt;/span&gt;&lt;/a&gt;&lt;/li&gt;
        &lt;li&gt;&lt;a href=&quot;#&quot;&gt;&lt;em class=&quot;icon ni ni-activity-alt&quot;&gt;&lt;/em&gt;&lt;span&gt;Login Activity&lt;/span&gt;&lt;/a&gt;&lt;/li&gt;
    &lt;/ul&gt;
                                        ...
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                ...
                                                <ul class="preview-list">
                                                    ...
                                                    <li class="preview-item">
                                                        <span class="preview-title overline-title">Mix Uses</span>
                                                        <div class="dropdown-preview">
                                                            <div class="dropdown-menu">
                                                                <ul class="link-list-plain no-bdr">
                                                                    <li><a href="#"><span>Profile Settings</span></a></li>
                                        ...
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#linkListPlain3" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="linkListPlain3">
    &lt;ul class=&quot;link-list-plain no-bdr&quot;&gt;
        &lt;li&gt;&lt;a href=&quot;#&quot;&gt;&lt;em class=&quot;icon ni ni-setting&quot;&gt;&lt;/em&gt;&lt;span&gt;Profile Settings&lt;/span&gt;&lt;/a&gt;&lt;/li&gt;
        &lt;li&gt;&lt;a href=&quot;#&quot;&gt;&lt;em class=&quot;icon ni ni-notify&quot;&gt;&lt;/em&gt;&lt;span&gt;Notification&lt;/span&gt;&lt;/a&gt;&lt;/li&gt;
        &lt;li class=&quot;divider&quot;&gt;&lt;/li&gt;
    ...
    &lt;/ul&gt;
                                        ...
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                <h6 class="title mb-3">Multiple Column</h6>
                                                <ul class="preview-list">
                                                    <li class="preview-item">
                                                        <span class="preview-title overline-title">3 Column</span>
                                                        <div class="dropdown-preview">
                                                    ...
                                                    <li class="preview-item">
                                                        <span class="preview-title overline-title">4 Column</span>
                                                        <div class="dropdown-preview">
                                                            <div class="dropdown-menu dropdown-menu-lg">
                                                                <ul class="link-list-plain li-col4x text-center">
                                                                    <li><a href="#">Jan</a></li>
                                                                    <li><a href="#">Feb</a></li>
                                                                    <li><a href="#">Mar</a></li>
                                                                    <li><a href="#">Apr</a></li>
                                        ...
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#linkListPlain4" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="linkListPlain4">
    &lt;ul class=&quot;link-list-plain li-col3x text-center&quot;&gt;
        &lt;li&gt;&lt;a href=&quot;#&quot;&gt;Jan&lt;/a&gt;&lt;/li&gt;
        &lt;li&gt;&lt;a href=&quot;#&quot;&gt;Feb&lt;/a&gt;&lt;/li&gt;
        &lt;li&gt;&lt;a href=&quot;#&quot;&gt;Mar&lt;/a&gt;&lt;/li&gt;
    ...
    &lt;/ul&gt;
                                        ...
                                        <div class="card card-bordered card-preview">
                                            <table class="table preview-reference">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><code>.no-bdr</code></td>
                                                        <td>Use <code>no-bdr</code> class with <code>ul.link-list-plain</code> tag for borderless list style. <br><em>Note: This class will not work for <code>.li-{col}</code> styling.</em></td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>.divider</code></td>
                                                        <td>Use <code>divider</code> class with blank <code>li</code> tag to get a divider.</td>
                                                    ...
                                                    <tr>
                                                        <td><code>.sm</code></td>
                                                        <td>Use <code>sm</code> class with <code>ul.link-list-plain</code> for compact style.</td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>.li-{col}</code></td>
                                                        <td>Use <code>{col}</code> as <code>col2x, col3x, col4x</code> with <code>ul.link-list-plain</code> list for column based list.</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div><!-- .card-preview -->
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h5 class="title nk-block-title">Example 3 - Tidy Style</h5>
                                                <p>Use <code>.link-tidy</code> class on <code>ul</code> to get styles shown in card below.</p>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                <ul class="preview-list">
                                                                ...
                                                                <ul class="link-tidy">
                                                                    <li>
                                                                        <div class="custom-control custom-control-sm custom-checkbox">
                                                                            <input type="checkbox" class="custom-control-input" checked="" id="check-bl">
                                                                            <label class="custom-control-label" for="check-bl">Balance</label>
                                                                        </div>
                                                                    </li>
                                                                    <li>
                                                                        <div class="custom-control custom-control-sm custom-checkbox">
                                                                            <input type="checkbox" class="custom-control-input" id="check-ph">
                                                                            <label class="custom-control-label" for="check-ph">Phone</label>
                                                                        </div>
                                                                    </li>
                                                                    <li>
                                                                        <div class="custom-control custom-control-sm custom-radio">
                                                                            <input type="radio" class="custom-control-input" checked="" name="radio-list" id="radio-bl">
                                                                            <label class="custom-control-label" for="radio-bl">Balance</label>
                                                                        </div>
                                                                    </li>
                                                                    <li>
                                                                        <div class="custom-control custom-control-sm custom-radio">
                                                                            <input type="radio" class="custom-control-input" name="radio-list" id="radio-ph">
                                                                            <label class="custom-control-label" for="radio-ph">Phone</label>
                                                                        </div>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                    ...
                                                    <li class="preview-item">
                                                        <span class="preview-title overline-title">Without Border</span>
                                                        <div class="dropdown-preview">
                                                            <div class="dropdown-menu">
                                                                <ul class="link-tidy no-bdr">
                                                                    <li>
                                                                        <div class="custom-control custom-control-sm custom-checkbox">
                                                                            <input type="checkbox" class="custom-control-input" checked="" id="check-bl2">
                                                                            <label class="custom-control-label" for="check-bl2">Balance</label>
                                                                        </div>
                                                                    </li>
                                                                    <li>
                                                                        <div class="custom-control custom-control-sm custom-checkbox">
                                                                            <input type="checkbox" class="custom-control-input" id="check-ph2">
                                                                            <label class="custom-control-label" for="check-ph2">Phone</label>
                                                                        </div>
                                                                    </li>
                                                                    <li>
                                                                        <div class="custom-control custom-control-sm custom-radio">
                                                                            <input type="radio" class="custom-control-input" checked="" name="radio-list-2" id="radio-bl2">
                                                                            <label class="custom-control-label" for="radio-bl2">Balance</label>
                                                                        </div>
                                                                    </li>
                                                                    <li>
                                                                        <div class="custom-control custom-control-sm custom-radio">
                                                                            <input type="radio" class="custom-control-input" name="radio-list-2" id="radio-ph2">
                                                                            <label class="custom-control-label" for="radio-ph2">Phone</label>
                                                                        </div>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        ...
                                                        <div class="dropdown-preview">
                                                            <div class="dropdown-menu">
                                                                <ul class="link-tidy sm">
                                                                    <li>
                                                                        <div class="custom-control custom-control-sm custom-checkbox">
                                                                            <input type="checkbox" class="custom-control-input" checked="" id="check-bl3">
                                                                            <label class="custom-control-label" for="check-bl3">Balance</label>
                                                                        </div>
                                                                    </li>
                                                                    <li>
                                                                        <div class="custom-control custom-control-sm custom-checkbox">
                                                                            <input type="checkbox" class="custom-control-input" id="check-ph3">
                                                                            <label class="custom-control-label" for="check-ph3">Phone</label>
                                                                        </div>
                                                                    </li>
                                                                    <li>
                                                                        <div class="custom-control custom-control-sm custom-radio">
                                                                            <input type="radio" class="custom-control-input" checked="" name="radio-list-3" id="radio-bl3">
                                                                            <label class="custom-control-label" for="radio-bl3">Balance</label>
                                                                        </div>
                                                                    </li>
                                                                    <li>
                                                                        <div class="custom-control custom-control-sm custom-radio">
                                                                            <input type="radio" class="custom-control-input" name="radio-list-3" id="radio-ph3">
                                                                            <label class="custom-control-label" for="radio-ph3">Phone</label>
                                                                        </div>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                                ...
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        <ul class="link-tidy">
                                                                            <li>
                                                                                <div class="custom-control custom-control-sm custom-checkbox">
                                                                                    <input type="checkbox" class="custom-control-input" checked="" id="cdp1-blx">
                                                                                    <label class="custom-control-label" for="cdp1-blx">Balance</label>
                                                                                </div>
                                                                            </li>
                                                                            <li>
                                                                                <div class="custom-control custom-control-sm custom-checkbox">
                                                                                    <input type="checkbox" class="custom-control-input" id="cdp1-phx">
                                                                                    <label class="custom-control-label" for="cdp1-phx">Phone</label>
                                                                                </div>
                                                                            </li>
                                                                            <li>
                                                                                <div class="custom-control custom-control-sm custom-checkbox">
                                                                                    <input type="checkbox" class="custom-control-input" id="cdp1-vrix">
                                                                                    <label class="custom-control-label" for="cdp1-vrix">Verified</label>
                                                                                </div>
                                                                            </li>
                                                                            <li>
                                                                                <div class="custom-control custom-control-sm custom-checkbox">
                                                                                    <input type="checkbox" class="custom-control-input" id="cdp1-stx">
                                                                                    <label class="custom-control-label" for="cdp1-stx">Status</label>
                                                                                </div>
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                                ...
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-end">
                                                                        <ul class="link-tidy">
                                                                            <li>
                                                                                <div class="custom-control custom-control-sm custom-checkbox">
                                                                                    <input type="checkbox" class="custom-control-input" checked="" id="cdp1-dot-bly">
                                                                                    <label class="custom-control-label" for="cdp1-dot-bly">Balance</label>
                                                                                </div>
                                                                            </li>
                                                                            <li>
                                                                                <div class="custom-control custom-control-sm custom-checkbox">
                                                                                    <input type="checkbox" class="custom-control-input" id="cdp1-dot-phy">
                                                                                    <label class="custom-control-label" for="cdp1-dot-phy">Phone</label>
                                                                                </div>
                                                                            </li>
                                                                            <li>
                                                                                <div class="custom-control custom-control-sm custom-checkbox">
                                                                                    <input type="checkbox" class="custom-control-input" id="cdp1-dot-vriy">
                                                                                    <label class="custom-control-label" for="cdp1-dot-vriy">Verified</label>
                                                                                </div>
                                                                            </li>
                                                                            <li>
                                                                                <div class="custom-control custom-control-sm custom-checkbox">
                                                                                    <input type="checkbox" class="custom-control-input" id="cdp1-dot-sty">
                                                                                    <label class="custom-control-label" for="cdp1-dot-sty">Status</label>
                                                                                </div>
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                        ...
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#linkTidy1" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="linkTidy1">
    &lt;ul class=&quot;link-tidy&quot;&gt;
        &lt;li&gt;
            &lt;div class=&quot;custom-control custom-control-sm custom-checkbox&quot;&gt;
    ...
    &lt;/ul&gt;
                                        ...
                                        <div class="card card-bordered card-preview">
                                            <table class="table preview-reference">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><code>.no-bdr</code></td>
                                                        <td>Use <code>no-bdr</code> class with <code>ul.link-tidy</code> tag for borderless list style.</td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>.sm</code></td>
                                                        <td>Use <code>sm</code> class with <code>ul.link-tidy</code> for compact style.</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div><!-- .card-preview -->
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h5 class="title nk-block-title">Example 4 - Menu Style</h5>
                                                <p>Use <code>.link-list-menu</code> class on <code>ul</code> to get styles shown in card below.</p>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                <ul class="preview-list">
                                                    ...
                                                    <li class="preview-item">
                                                        <span class="preview-title overline-title">Active Link</span>
                                                        <div class="dropdown-preview">
                                                            <div class="dropdown-menu">
                                                                <ul class="link-list-menu">
                                                    ...
                                                    <li class="preview-item">
                                                        <span class="preview-title overline-title">With Divider</span>
                                                        <div class="dropdown-preview">
                                                            <div class="dropdown-menu">
                                                                <ul class="link-list-menu">
                                                                    <li><a href="#"><span>Account Settings</span></a></li>
                                        ...
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#linkListMenu1" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="linkListMenu1">
    &lt;ul class=&quot;link-list-menu&quot;&gt;
        &lt;li class=&quot;active&quot;&gt;&lt;a href=&quot;#&quot;&gt;&lt;span&gt;Account Settings&lt;/span&gt;&lt;/a&gt;&lt;/li&gt;
        &lt;li&gt;&lt;a href=&quot;#&quot;&gt;&lt;span&gt;My Account&lt;/span&gt;&lt;/a&gt;&lt;/li&gt;
        &lt;li&gt;&lt;a href=&quot;#&quot;&gt;&lt;span&gt;Sign out&lt;/span&gt;&lt;/a&gt;&lt;/li&gt;
    &lt;/ul&gt;
                                        ...
                                        <div class="card card-bordered card-preview">
                                            <table class="table preview-reference">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><code>.active</code></td>
                                                        <td>Use <code>active</code> class with <code>li</code> tag for active style.</td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>.divider</code></td>
                                                        <td>Use <code>divider</code> class with blank <code>li</code> tag to get a divider.</td>
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h5 class="title nk-block-title">Example 5 - with Heading</h5>
                                                <p>Use <code>.link-check</code> class on <code>ul</code> to get styles shown in card below.</p>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                                ...
                                                <ul class="preview-list">
                                                    <li class="preview-item">
                                                        ...
                                                        <div class="dropdown-preview">
                                                            <div class="dropdown-menu">
                                                                <ul class="link-check">
                                                                    <li><span>Quick Insert</span></li>
                                                                    <li><a href="#">Hello Team!</a></li>
                                                                    <li><a href="#">Thank You!</a></li>
                                                                    <li><a href="#">Most Welcome!</a></li>
                                                                </ul>
                                                                <ul class="link-check">
                                                    ...
                                                    <li class="preview-item">
                                                        <span class="preview-title overline-title">Selected</span>
                                                        <div class="dropdown-preview">
                                                            <div class="dropdown-menu">
                                                                <ul class="link-check">
                                                        ...
                                                        <div class="dropdown-preview">
                                                            <div class="dropdown-menu">
                                                                <ul class="link-check">
                                                                    ...
                                                                    <li class="divider"></li>
                                                                    <li><span>Order By</span></li>
                                                                    <li class="active"><a href="#"><em class="icon ni ni-arrow-long-up"></em>DESC</a></li>
                                                                    <li><a href="#"><em class="icon ni ni-arrow-long-down"></em>ASC</a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </li><!-- li -->
                                                    <li class="preview-item">
                                                        ...
                                                        <ul class="d-flex g-3">
                                                            ...
                                                            <li>
                                                                <div class="dropdown">
                                                                    <a class="dropdown-toggle btn btn-light btn-icon" data-bs-toggle="dropdown"><em class="icon ni ni-more-h"></em></a>
                                        ...
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#linkCheck2" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="linkCheck2">
    &lt;ul class=&quot;link-check&quot;&gt;
        &lt;li&gt;&lt;span&gt;Show&lt;/span&gt;&lt;/li&gt;
        &lt;li class=&quot;active&quot;&gt;&lt;a href=&quot;#&quot;&gt;10 Items&lt;/a&gt;&lt;/li&gt;
        &lt;li&gt;&lt;a href=&quot;#&quot;&gt;20 Items&lt;/a&gt;&lt;/li&gt;
                                        ...
                                        <div class="card card-bordered card-preview">
                                            <table class="table preview-reference">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><code>.divider</code></td>
                                                        <td>Use <code>divider</code> class with blank <code>li</code> tag to get a divider.<br>Alernately you can use two <code>ul</code> set with <code>.link-check</code> class</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div><!-- .card-preview -->
