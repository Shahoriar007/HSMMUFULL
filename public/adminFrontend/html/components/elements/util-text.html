...
<head>
    ...
    <!-- Page Title  -->
    <title>Text Utility | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                                ...
                                <div class="components-preview wide-md mx-auto">
                                    <div class="nk-block-head nk-block-head-lg wide-sm">
                                        <div class="nk-block-head-content">
                                            ...
                                            <h2 class="nk-block-title fw-normal">Text Utility</h2>
                                            <div class="nk-block-des">
                                                <p class="lead">Dashlite includes several predefined button styles, each serving its own semantic purpose, with a few extras thrown in for more control.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Text alignment</h4>
                                        ...
                                        <div class="card card-bordered card-preview">
                                            <table class="table preview-reference">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <code>.text-{value}</code><br>
                                                            <code>.text-{screen}-{value}</code>
                                                        </td>
                                                        <td>left | right | justify | center</td>
                                                        <td class="text-soft"> Alignment the text<br>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="3">
                                                            <em class="fs-13px">Use <code>{screen}</code> as <code>sm, md, lg, xl, xxl</code>. Please note, <code>{screen}</code> related with breakpoint and will apply from the <code>{screen}</code> to above. For example, <code>.m-sm-2</code> sets padding on <code>sm</code> screen and continue to above screens.</em>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
...
&lt;p class=&quot;text-center text-lg-start&quot;&gt;...&lt;/p&gt;
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Text transform</h4>
                                        ...
                                        <div class="card card-bordered card-preview">
                                            <table class="table preview-reference">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><code>.lcap, .text-lowercase</code></td>
                                                        <td>lowercased text.</td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>.ucap, .text-uppercase</code></td>
                                                        <td>UPPERCASED TEXT.</td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>.ccap, .text-capitalize</code></td>
...
&lt;p class=&quot;text-uppercase&quot;&gt;...&lt;/p&gt;
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Fixed Font Size</h4>
...
&lt;p class=&quot;fs-9px&quot;&gt;...&lt;/p&gt;
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Font Family &amp; Style</h4>
                                            ...
                                            <table class="table preview-reference">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <p class="ff-base">Base Font Family</p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>.ff-alt</code></td>
                                                        <td>
                                                            <p class="ff-alt">Alter Font Family</p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>.ff-mono</code></td>
                                                        <td>
                                                            <p class="ff-mono">Mono Font Family</p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>.ff-italic</code></td>
                                                        <td>
                                                            <p class="ff-italic">Italic text line.</p>
                                                        </td>
                                                    </tr>
                                                    <tr>
...
&lt;p class=&quot;ff-mono&quot;&gt;...&lt;/p&gt;
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Additional Classes</h4>
                                                <p>Here is few more classes that will helps you style the text.</p>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                            <table class="table preview-reference">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <p class="text-reset">Reset a text color</p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <p class="text-decoration-none">Remove a text decoration</p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>.text-ellipsis</code></td>
                                                        <td>
                                                            <p class="text-ellipsis w-150px">Ellipsis text &amp; auto dot end</p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>.text-wrap</code></td>
                                                        <td>
                                                            <p class="text-wrap">Wrapping any text</p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <p><code>.text-nowrap</code>
                                                        </td>
                                                        <td>
                                                            <p class="text-nowrap">Prevent text from wrapping.</p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>.text-break</code></td>
                                                        <td>
                                                            <p class="text-break">To break long string</p>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
