...
<head>
    ...
    <!-- Page Title  -->
    <title>Buttons | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                                ...
                                <div class="components-preview wide-md mx-auto">
                                    <div class="nk-block-head nk-block-head-lg wide-sm">
                                        <div class="nk-block-head-content">
                                            ...
                                            <h2 class="nk-block-title fw-normal">Buttons</h2>
                                            <div class="nk-block-des">
                                                <p class="lead">Documentation and examples of button styles for actions in forms, dialogs, and more with support for multiple sizes, states, and more.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="nk-block nk-block-lg">
                                        ...
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                <ul class="preview-btn-list">
                                                    ...
                                                    <li class="preview-btn-item">
                                                        <span class="preview-title overline-title">Success</span>
                                                        <a href="#" class="btn btn-success">Success</a>
                                                    </li>
                                                    <li class="preview-btn-item">
                                                        <span class="preview-title overline-title">Danger</span>
                                                        <a href="#" class="btn btn-danger">Danger</a>
                                                    </li>
                                                    <li class="preview-btn-item">
                                                        <span class="preview-title overline-title">Warning</span>
                                                        <a href="#" class="btn btn-warning">Warning</a>
                                                    </li>
                                                    <li class="preview-btn-item">
                                                        <span class="preview-title overline-title">Info</span>
                                                        <a href="#" class="btn btn-info">Info</a>
                                                    </li>
                                                    <li class="preview-btn-item">
                                                        <span class="preview-title overline-title">Light</span>
                                                        <a href="#" class="btn btn-light">Light</a>
                                                    </li>
                                                    <li class="preview-btn-item">
                                                        <span class="preview-title overline-title">Dark</span>
                                        ...
                                        <div class="code-block">
                                            ...
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#btnCode1" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="btnCode1">
&lt;a href=&quot;#&quot; class=&quot;btn btn-primary&quot;&gt;Primary&lt;/a&gt;
</pre>
                                        </div><!-- .code-block -->
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                <ul class="preview-btn-list">
                                                    ...
                                                    <li class="preview-btn-item">
                                                        <span class="preview-title overline-title">Secondary</span>
                                                        <a href="#" class="btn btn-dim btn-secondary">Secondary</a>
                                                    </li>
                                                    <li class="preview-btn-item">
                                                        <span class="preview-title overline-title">Success</span>
                                                        <a href="#" class="btn btn-dim btn-success">Success</a>
                                                    </li>
                                                    <li class="preview-btn-item">
                                                        <span class="preview-title overline-title">Danger</span>
                                                        <a href="#" class="btn btn-dim btn-danger">Danger</a>
                                                    </li>
                                                    <li class="preview-btn-item">
                                                        <span class="preview-title overline-title">Warning</span>
                                                        <a href="#" class="btn btn-dim btn-warning">Warning</a>
                                                    </li>
                                                    <li class="preview-btn-item">
                                                        <span class="preview-title overline-title">Info</span>
                                                        <a href="#" class="btn btn-dim btn-info">Info</a>
                                                    </li>
                                                    <li class="preview-btn-item">
                                                        <span class="preview-title overline-title">Light</span>
                                                        <a href="#" class="btn btn-dim btn-light">Light</a>
                                                    </li>
                                                    <li class="preview-btn-item">
                                                        <span class="preview-title overline-title">Dark</span>
                                                        <a href="#" class="btn btn-dim btn-dark">Dark</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div><!-- .card-preview -->
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#btnCode2" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="btnCode2">
&lt;a href=&quot;#&quot; class=&quot;btn btn-dim btn-primary&quot;&gt;Primary&lt;/a&gt;
</pre>
                                        </div><!-- .code-block -->
                                        <div class="card card-bordered card-preview">
                                        ...
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#btnCode3" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="btnCode3">
&lt;a href=&quot;#&quot; class=&quot;btn btn-outline-primary&quot;&gt;Primary&lt;/a&gt;
</pre>
                                        </div><!-- .code-block -->
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                <ul class="preview-btn-list">
                                                    ...
                                                    <li class="preview-btn-item">
                                                        <span class="preview-title overline-title">Secondary</span>
                                                        <a href="#" class="btn btn-dim btn-outline-secondary">Secondary</a>
                                                    </li>
                                                    <li class="preview-btn-item">
                                                        <span class="preview-title overline-title">Success</span>
                                                        <a href="#" class="btn btn-dim btn-outline-success">Success</a>
                                                    </li>
                                                    <li class="preview-btn-item">
                                                        <span class="preview-title overline-title">Danger</span>
                                                        <a href="#" class="btn btn-dim btn-outline-danger">Danger</a>
                                                    </li>
                                                    <li class="preview-btn-item">
                                                        <span class="preview-title overline-title">Warning</span>
                                                        <a href="#" class="btn btn-dim btn-outline-warning">Warning</a>
                                                    </li>
                                                    <li class="preview-btn-item">
                                                        <span class="preview-title overline-title">Info</span>
                                                        <a href="#" class="btn btn-dim btn-outline-info">Info</a>
                                                    </li>
                                                    <li class="preview-btn-item">
                                                        <span class="preview-title overline-title">Light</span>
                                                        <a href="#" class="btn btn-dim btn-outline-light">Light</a>
                                                    </li>
                                                    <li class="preview-btn-item">
                                                        <span class="preview-title overline-title">Dark</span>
                                                        <a href="#" class="btn btn-dim btn-outline-dark">Dark</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div><!-- .card-preview -->
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#btnCode4" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="btnCode4">
&lt;a href=&quot;#&quot; class=&quot;btn btn-dim btn-outline-primary&quot;&gt;Primary&lt;/a&gt;
</pre>
                                        </div><!-- .code-block -->
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                <ul class="row g-gs">
                                                    <li class="col-sm-6 col-lg-3">
                                                        <span class="preview-title overline-title">Button Extra Large</span>
                                                        <a href="#" class="btn btn-xl btn-primary">Button Large</a>
                                                    </li>
                                                    <li class="col-sm-6 col-lg-3">
                                                        <span class="preview-title overline-title">Button Large</span>
                                                        <a href="#" class="btn btn-lg btn-primary">Button Regular</a>
                                                    </li>
                                                    <li class="col-sm-6 col-lg-3">
                                                        <span class="preview-title overline-title">Button Regular</span>
                                                        <a href="#" class="btn btn-primary">Button Regular</a>
                                                    </li>
                                                    <li class="col-sm-6 col-lg-3">
                                                        <span class="preview-title overline-title">Button Small</span>
                                                        <a href="#" class="btn btn-sm btn-primary">Button Small</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div><!-- .card-preview -->
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#btnCode5" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="btnCode5">
&lt;a href=&quot;#&quot; class=&quot;btn btn-xl btn-primary&quot;&gt;Button Large&lt;/a&gt;
</pre>
                                        </div><!-- .code-block -->
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                <ul class="row g-gs">
                                                    <li class="col-sm-6 col-lg-3">
                                                        <span class="preview-title overline-title">Button Extra Large</span>
                                                        <a href="#" class="btn btn-round btn-xl btn-primary">Button Large</a>
                                                    </li>
                                                    <li class="col-sm-6 col-lg-3">
                                                        <span class="preview-title overline-title">Button Large</span>
                                                        <a href="#" class="btn btn-round btn-lg btn-primary">Button Regular</a>
                                                    </li>
                                                    <li class="col-sm-6 col-lg-3">
                                                        <span class="preview-title overline-title">Button Regular</span>
                                        ...
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#btnCode6" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="btnCode6">
&lt;a href=&quot;#&quot; class=&quot;btn btn-xl btn-primary&quot;&gt;Button Large&lt;/a&gt;
</pre>
                                        </div><!-- .code-block -->
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                <ul class="row g-gs">
                                                    <li class="col-sm-6 col-lg-3">
                                                        <span class="preview-title overline-title">Left Icon</span>
                                                        <a href="#" class="btn btn-primary"><em class="icon ni ni-setting"></em><span>Button Left Icon</span> </a>
                                                    </li>
                                                    <li class="col-sm-6 col-lg-3">
                                                        <span class="preview-title overline-title">Right Icon</span>
                                                        <a href="#" class="btn btn-primary"><span>Button Right Icon</span><em class="icon ni ni-setting"></em></a>
                                                    </li>
                                                    <li class="col-sm-6 col-lg-3">
                                                        <span class="preview-title overline-title">Action Button</span>
                                                        <div class="dropdown">
                                                            <a href="#" class="btn btn-primary" data-bs-toggle="dropdown"><span>Action Button</span><em class="icon ni ni-chevron-down"></em></a>
                                        ...
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#btnCode7" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="btnCode7">
...
&lt;a href=&quot;#&quot; class=&quot;btn btn-round btn-sm btn-primary&quot;&gt;Button Small&lt;/a&gt;
                                        ...
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                <ul class="row g-gs">
                                                    <li class="col-sm-6 col-lg-3">
                                                        <span class="preview-title overline-title">Left Icon</span>
                                                        <a href="#" class="btn btn-round btn-primary"><em class="icon ni ni-setting"></em><span>Button Left Icon</span> </a>
                                                    </li>
                                                    <li class="col-sm-6 col-lg-3">
                                                        <span class="preview-title overline-title">Right Icon</span>
                                                        <a href="#" class="btn btn-round btn-primary"><span>Button Right Icon</span><em class="icon ni ni-setting"></em></a>
                                                    </li>
                                                    <li class="col-sm-6 col-lg-3">
                                                        <span class="preview-title overline-title">Action Button</span>
                                                        <div class="dropdown">
                                                            <a href="#" class="btn btn-round btn-primary" data-bs-toggle="dropdown"><span>Action Button</span><em class="icon ni ni-chevron-down"></em></a>
                                                    ...
                                                    <li class="col-sm-6 col-lg-3">
                                                        <span class="preview-title overline-title">Icon on Right</span>
                                                        <a href="#" class="btn btn-wider btn-primary"><span>Action Button</span><em class="icon ni ni-arrow-right"></em></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div><!-- .card-preview -->
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#btnCode8" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="btnCode8">
...
&lt;a href=&quot;#&quot; class=&quot;btn btn-primary btn-action&quot;&gt;&lt;span&gt;Button Regular&lt;/span&gt;&lt;em class=&quot;icon ni ni-chevron-down&quot;&gt;&lt;/em&gt;&lt;/a&gt;
                                        ...
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                <ul class="preview-btn-list preview-btn-list-3x text-center">
                                                    <li class="preview-btn-item">
                                                        <span class="preview-title overline-title">lg</span>
                                                        <a href="#" class="btn btn-icon btn-lg btn-primary"><em class="icon ni ni-play"></em></a>
                                                    </li>
                                                    <li class="preview-btn-item">
                                                        <span class="preview-title overline-title">Rg</span>
                                                        <a href="#" class="btn btn-icon btn-primary"><em class="icon ni ni-play"></em></a>
                                                    </li>
                                                    <li class="preview-btn-item">
                                                        <span class="preview-title overline-title">Sm</span>
                                                        <a href="#" class="btn btn-icon btn-sm btn-primary"><em class="icon ni ni-play"></em></a>
                                                    </li>
                                                    <li class="preview-btn-item">
                                                        <span class="preview-title overline-title">lg</span>
                                                        <a href="#" class="btn btn-round btn-icon btn-lg btn-primary"><em class="icon ni ni-play"></em></a>
                                                    </li>
                                                    <li class="preview-btn-item">
                                                        <span class="preview-title overline-title">Rg</span>
                                                        <a href="#" class="btn btn-round btn-icon btn-primary"><em class="icon ni ni-play"></em></a>
                                                    </li>
                                                    <li class="preview-btn-item">
                                                        <span class="preview-title overline-title">Sm</span>
                                                        <a href="#" class="btn btn-round btn-icon btn-sm btn-primary"><em class="icon ni ni-play"></em></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div><!-- .card-preview -->
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#btnCode9" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="btnCode9">
&lt;a href=&quot;#&quot; class=&quot;btn btn-icon btn-lg btn-primary&quot;&gt;&lt;em class=&quot;icon ni ni-play&quot;&gt;&lt;/em&gt;&lt;/a&gt;
</pre>
                                        </div><!-- .code-block -->
                                    </div>
