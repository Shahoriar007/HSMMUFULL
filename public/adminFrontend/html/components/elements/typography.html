...
<head>
    ...
    <!-- Page Title  -->
    <title>Typography | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                                ...
                                <div class="components-preview wide-md mx-auto">
                                    <div class="nk-block-head nk-block-head-lg wide-sm">
                                        <div class="nk-block-head-content">
                                            ...
                                            <h2 class="nk-block-title fw-normal">Typography</h2>
                                            <div class="nk-block-des">
                                                <p class="lead">These examples for typography, including global settings, headings, body text, lists, and more. When more control is needed, check out the <a href="html/components/elements/util-text.html">textual utility classes</a>.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Headings</h4>
                                                <p>All HTML headings, <code class="code-tag">&lt;h1&gt;</code> through <code class="code-tag">&lt;h6&gt;</code>, are available.</p>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                            <table class="table table-lg preview-reference">
                                                <thead class="table-light">
                                                    <tr>
                                                        <th class="overline-title w-250px">Heading</th>
                                                        <th class="overline-title">Example</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                        ...
                                        <div class="card card-bordered card-preview">
                                            <table class="table preview-reference">
                                                <thead class="table-light">
                                                    <tr>
                                                        <th class="overline-title w-250px">Class Reference</th>
                                                        <th class="overline-title ">Note</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        <td><code>&lt;h[num]&gt;</code>, <code>.h[num]</code></td>
                                                        <td>1 | 2 | 3 | 4 | 5 | 6</td>
                                                    </tr>
                                                </tbody>
                                            </table>
...
&lt;span class=&quot;title h4&quot;&gt; ... &lt;/span&gt;
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Customizing headings</h4>
                                                <p>Use the <a href="html/components/elements/util-text.html">text utility classes</a> to more customizing the heading text.</p>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                <h3 class="ff-base fw-medium"> Fancy display heading <small class="text-soft">With faded secondary text</small>
                                                </h3>
                                            </div>
                                        </div><!-- .card-preview -->
                                        <div class="code-block code-block-clean">
...
&lt;/h3&gt;
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Inline Element & Text Style</h4>
                                                <p>Change text alignment, transform, style, weight, and color with our <a href="html/components/elements/util-text.html">text utilities</a> and <a href="html/components/elements/util-colors.html">color utilities</a>.</p>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                            <table class="table table-lg preview-reference">
                                                <thead class="table-light">
                                                    <tr>
                                                        <th class="overline-title w-250px">Code Reference</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><code>&lt;sup&gt;</code></td>
                                                        <td>
                                                            <p>This <sup>text</sup> rendered as superscript</p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>&lt;sub&gt;</code></td>
                                                        <td>
                                                            <p>This <sub>text</sub> rendered as subscript</p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>&lt;abbr&gt;</code></td>
                                                        <td>
                                                            <p>Abbreviations have a <abbr title="hello">default underline</abbr> and gain a help cursor</p>
                                                        </td>
                                                    </tr>
                                                    <tr>
...
&lt;p class=&quot;lead&quot;&gt;This line of text is meant to lead text to stand out.&lt;/p&gt;
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Blockquotes</h4>
                                                <p>For quoting blocks of content from another source within your document. Use <code>.blockquote</code> in <code class="code-tag">&lt;blockquote&gt;</code>.</p>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                        ...
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                <figure class="text-end mb-0">
                                                    ...
                                                    <figcaption class="blockquote-footer mb-0"> Someone famous in <cite title="Source Title">Source Title</cite>
                                                    </figcaption>
                                                </figure>
                                            </div>
                                        </div><!-- .card-preview -->
                                        <div class="code-block">
                                            ...
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#Typography7" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="Typography7">
&lt;figure class=&quot;text-center&quot;&gt;
    &lt;blockquote class=&quot;blockquote&quot;&gt;
      &lt;p&gt;A well-known quote, contained in a blockquote element.&lt;/p&gt;
    &lt;/blockquote&gt;
  ...
  &lt;/figure&gt;
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Lists - Style</h4>
                                                <p>Use <code>.list</code> class with <code class="code-tag">&lt;ul&gt;</code> element to style basic listing. Also your can use <code>.list-checked</code> with <code>.list</code> class for different style as below.</p>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                ...
                                                <p class="mt-4 ff-italic text-soft">Additionally you can use <code>.list-sm</code> and <code>.list-lg</code> for displaying small and large. </p>
                                            </div>
                                        </div><!-- .card-preview -->
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#Typography11" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="Typography11">
&lt;ul class=&quot;list list-checked&quot;&gt;
  &lt;li&gt;Lorem ipsum dolor sit amet&lt;/li&gt;
    &lt;ul&gt;
      &lt;li&gt;Phasellus iaculis nequeep&lt;/li&gt;
...
&lt;/ul&gt;
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Lists - Unstyled</h4>
                                                <p>Use <code>.list-unstyled</code> class with <code class="code-tag">&lt;ul&gt;</code> element to make unstyled</p>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                        ...
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#Typography14" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="Typography14">
&lt;ul class=&quot;list-unstyled&quot;&gt;
  &lt;li&gt;Lorem ipsum dolor sit amet&lt;/li&gt;
    &lt;ul&gt;
      &lt;li&gt;Phasellus iaculis nequeep&lt;/li&gt;
...
&lt;/ul&gt;
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Lists - Inline</h4>
                                                <p>Remove a list’s bullets and apply some light <code class="code-fnc">margin</code> with a combination of two classes, <code>.list-inline</code> and <code>.list-inline-item</code>.</p>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                        ...
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#Typography12" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="Typography12">
&lt;ul class=&quot;list-inline&quot;&gt;
  &lt;li class=&quot;list-inline-item&quot;&gt;Lorem ipsum&lt;/li&gt;
  &lt;li class=&quot;list-inline-item&quot;&gt;Phasellus iaculis&lt;/li&gt;
  &lt;li class=&quot;list-inline-item&quot;&gt;Nulla volutpat&lt;/li&gt;
&lt;/ul&gt;
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Description list alignment</h4>
                                                <p>Align terms and descriptions horizontally by using our grid system’s predefined classes.</p>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                        ...
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#Typography13" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="Typography13">
&lt;dl class=&quot;row&quot;&gt;
  &lt;dt class=&quot;col-sm-3&quot;&gt;Description lists&lt;/dt&gt;
  &lt;dd class=&quot;col-sm-9&quot;&gt;A description list is perfect for defining terms.&lt;/dd&gt;
