...
<head>
    ...
    <!-- Page Title  -->
    <title>Modals | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                                        ...
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                <ul class="preview-list">
                                                    ...
                                                    <li class="preview-item">
                                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalSmall">Modal Small</button>
                                                    </li>
                                                    <li class="preview-item">
                                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalLarge">Modal Large</button>
                                                    </li>
                                                    <li class="preview-item">
                                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalTop">Modal Top</button>
                                                    </li>
                                                    <li class="preview-item">
                                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalBottom">Modal Bottom</button>
                                                    </li>
                                                    <li class="preview-item">
                                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalZoom">Modal Zoom</button>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div><!-- .card-preview -->
                                        ...
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                <ul class="preview-list ">
                                                    ...
                                                    <li class="preview-item">
                                                        <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#modalTabs">Modal With Tabs</button>
                                                    </li>
                                                    <li class="preview-item">
                                                        <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalAlert">Modal Success</button>
                                                    </li>
                                                    <li class="preview-item">
                                                        <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modalAlert2">Modal Danger</button>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div><!-- .card-preview -->
