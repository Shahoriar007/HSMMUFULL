...
<head>
    ...
    <!-- Page Title  -->
    <title>Border Utility | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                                ...
                                <div class="components-preview wide-md mx-auto">
                                    <div class="nk-block-head nk-block-head-lg wide-sm">
                                        <div class="nk-block-head-content">
                                            ...
                                            <h2 class="nk-block-title fw-normal">Border Utility</h2>
                                            <div class="nk-block-des">
                                                <p class="lead">Use border utilities to quickly style the border and border-radius of an element.</p>
                                            </div>
                                        </div>
                                    </div>
...
&lt;div class=&quot;border-top&quot;&gt;&lt;/div&gt;
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Subtractive Border</h4>
                                                <p>You can remove border to a single side of an element with below border utilities classes.</p>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                <div class="d-flex flex-wrap example-border example-border-all">
...
&lt;div class=&quot;border-top-0&quot;&gt;&lt;/div&gt;
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Border Color</h4>
...
&lt;div class=&quot;border border-primary&quot;&gt;&lt;/div&gt;
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Border Radius</h4>
                                        ...
                                        <div class="card card-bordered card-preview">
                                            <table class="table preview-reference">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><code>.rounded-{top|bottom|left|right}</code></td>
