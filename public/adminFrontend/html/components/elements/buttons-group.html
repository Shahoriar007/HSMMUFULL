...
<head>
    ...
    <!-- Page Title  -->
    <title>Buttons Group | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                                ...
                                <div class="components-preview wide-md mx-auto">
                                    <div class="nk-block-head nk-block-head-lg wide-sm">
                                        <div class="nk-block-head-content">
                                            ...
                                            <h2 class="nk-block-title fw-normal">Buttons Group</h2>
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h5 class="title nk-block-title">Basic Example</h5>
                                                <p>Combine sets of button to wrap a series of buttons with <code>.btn</code> in <code>.btn-group</code>.</p>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                <div class="row g-gs">
                                                    <div class="col-sm-6">
                                                        <div class="preview-title overline-title">Default Buttons</div>
                                                        <div class="btn-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="preview-title overline-title">Dim Buttons</div>
                                                        <div class="btn-group">
                                                            <button type="button" class="btn btn-dim btn-primary">Left</button>
                                                            <button type="button" class="btn btn-dim btn-primary">Middle</button>
                                                            <button type="button" class="btn btn-dim btn-primary">Right</button>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="preview-title overline-title">Outlined Buttons</div>
                                                        <div class="btn-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="preview-title overline-title">Dim &amp; Outlined Buttons</div>
                                                        <div class="btn-group">
                                                            <button type="button" class="btn btn-dim btn-outline-primary">Left</button>
                                                            <button type="button" class="btn btn-dim btn-outline-primary">Middle</button>
                                                            <button type="button" class="btn btn-dim btn-outline-primary">Right</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="code-block">
                                            ...
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#buttonBasic1" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="buttonBasic1">
...
&lt;/div&gt;
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h5 class="title nk-block-title">Button Toolbar</h5>
                                        ...
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                <div class="g-2">
                                                    ...
                                                    <div class="btn-toolbar g-2 justify-content-between">
                                                        <div class="btn-group">
                                                            <button type="button" class="btn btn-primary">1</button>
                                                            <button type="button" class="btn btn-primary">2</button>
                                                            <button type="button" class="btn btn-primary">3</button>
                                        ...
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#buttonTool1" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="buttonTool1">
...
&lt;/div&gt;
                                        ...
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#buttonTool2" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="buttonTool2">
...
&lt;/div&gt;
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h5 class="title nk-block-title">Button Sizing</h5>
                                                <p>Just add <code>.btn-group-{sm|lg}</code> to each <code>.btn-group</code> class to control applying button sizing globaly.</p>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                        ...
                                        <div class="code-block">
                                            <h6 class="overline-title title">Code Example</h6>
                                            <button class="btn btn-sm clipboard-init" title="Copy to clipboard" data-clipboard-target="#buttonSize1" data-clip-success="Copied" data-clip-text="Copy"><span class="clipboard-text">Copy</span></button>
                                            <pre class="prettyprint lang-html" id="buttonSize1">
