...
<head>
    ...
    <!-- Page Title  -->
    <title>Others Utility | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                                ...
                                <div class="components-preview wide-md mx-auto">
                                    <div class="nk-block-head nk-block-head-lg wide-sm">
                                        <div class="nk-block-head-content">
                                            ...
                                            <h2 class="nk-block-title fw-normal">Other Utility Classes</h2>
                                            <div class="nk-block-des">
                                                <p class="lead">Here is some other utility classes that use to quickly style an element.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                ...
                                                <div class="nk-block-des">
                                                    <p>The <code>.gap</code> utility classes allow to set specific gap between to section or block.</p>
                                                </div>
                                            </div>
                                        </div>
