...
<head>
    ...
    <!-- Page Title  -->
    <title>Ratings Widgets | DashLite Admin Template</title>
    <!-- StyleSheets  -->
...
<body class="nk-body bg-lighter npc-general has-sidebar ">
                                ...
                                <div class="components-preview wide-md mx-auto">
                                    <div class="nk-block-head nk-block-head-lg wide-sm">
                                        <div class="nk-block-head-content">
                                            ...
                                            <h2 class="nk-block-title fw-normal">Card Style for Ratings</h2>
                                            <div class="nk-block-des">
                                                <p class="lead">Use ratings card with variant for an invaluable source of feedback.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Rating Card</h4>
                                            </div>
                                        </div>
    ...
    &lt;/div&gt;&lt;!-- .card --&gt;
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Customer Review</h4>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                            ...
                                                            <div class="card-inner">
                                                                <div class="d-flex align-center gy-3">
                                                                    <div class="progress-amount me-4">
                                                                        ...
                                                                        <span class="sub-text mt-1"><em class="icon ni ni-users-fill"></em> 47,860 Total</span>
                                                                    </div>
                                                                    <div class="rating-progress-bar gy-1 w-100">
                                                                        <div class="progress-rating">
                                                                            <div class="progress-rating me-2">5</div>
                                                                            <div class="progress progress-lg progress-alt bg-transparent">
                                                                                <div class="progress-bar bg-teal" data-progress="70"></div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="progress-rating">
                                                                            <div class="progress-rating me-2">4</div>
                                                                            <div class="progress progress-lg progress-alt bg-transparent">
                                                                                <div class="progress-bar bg-success" data-progress="55"></div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="progress-rating">
                                                                            <div class="progress-rating me-2">3</div>
                                                                            <div class="progress progress-lg progress-alt bg-transparent">
                                                                                <div class="progress-bar bg-info" data-progress="38"></div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="progress-rating">
                                                                            <div class="progress-rating me-2">2</div>
                                                                            <div class="progress progress-lg progress-alt bg-transparent">
                                                                                <div class="progress-bar bg-warning" data-progress="15"></div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="progress-rating">
                                                                            <div class="progress-rating me-2">1</div>
                                                                            <div class="progress progress-lg progress-alt bg-transparent">
                                                                                <div class="progress-bar bg-danger" data-progress="30"></div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                            ...
                                            <div class="card-inner">
                                                <div class="row g-gs">
                                                    <div class="col-md-6">
                                                        <div class="card card-bordered">
                                                            <div class="card-inner">
                                                                <h4 class="card-title mb-1">UI/UX Designer at Google</h4>
                                                                <ul class="rating">
                                                                    <li><em class="icon ni ni-star-fill"></em></li>
                                                                    <li><em class="icon ni ni-star-fill"></em></li>
                                                                    <li><em class="icon ni ni-star-fill"></em></li>
                                                                ...
                                                                <div class="d-flex justify-content-between align-items-end">
                                                                    <ul class="pt-2 gy-1">
                                                                        <li><em class="icon ni ni-map-pin"></em><span>60311 Frankfurt am Main, Italy</span></li>
                                                                        <li><em class="icon ni ni-calender-date"></em><span>28th Sept, 2021</span></li>
                                                                        <li><em class="icon ni ni-briefcase"></em><span>Fulltime</span></li>
                                                                    </ul>
                                                                    <span class="badge badge-dim badge-sm rounded-pill bg-outline-info">$1550.00</span>
                                                                </div>
                                                                <div class="collapse" id="collapseDes1">
                                                                    <div class="divider"></div>
                                                                    <div class="rating-card-description">
                                                                        <h5 class="card-title">Description</h5>
                                                                        <p class="text-muted">Some quick example text to build on the card title and make up the bulk of the card's content. Some quick example text to build on the card title bulk.</p>
                                                                        <ul class="pt-2 gy-1">
                                                                            <li><em class="icon ni ni-check-circle"></em><span>30 days off</span></li>
                                                                            <li><em class="icon ni ni-check-circle"></em><span>Free drinks</span></li>
                                                                            <li><em class="icon ni ni-check-circle"></em><span>Paid leave</span></li>
                                                                            <li><em class="icon ni ni-check-circle"></em><span>Healthcare</span></li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="card card-bordered">
                                                            <div class="card-inner">
                                                                <h4 class="card-title mb-1">Developer at Softnio</h4>
                                                                <ul class="rating">
                                                                    <li><em class="icon ni ni-star-fill"></em></li>
                                                                    <li><em class="icon ni ni-star-fill"></em></li>
                                                                    <li><em class="icon ni ni-star-fill"></em></li>
                                                            ...
                                                            <div class="card-footer rating-card-footer bg-light border-top d-flex align-center justify-content-between">
                                                                <a class="switch-text" data-bs-toggle="collapse" href="#collapseDes2">
                                                                    <div class="link link-gray switch-text-normal">
                                                                        <span>Less Info</span><em class="icon ni ni-upword-ios"></em>
                                                                    </div>
                                                                    <div class="link link-gray switch-text-collapsed">
    ...
    &lt;/div&gt;
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Institute Profile</h4>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                <div class="row g-gs">
                                                    <div class="col-md-6">
                                                        <div class="card card-bordered">
                                                            <div class="card-inner">
                                                                <h4 class="card-title mb-1">Softnio</h4>
                                                                <div class="rating-wrap my-1">
                                                                    ...
                                                                    <span class="amount">4.4 (78)</span>
                                                                </div>
                                                                <h5 class="card-title mt-4">Criteria on Softnio</h5>
                                                            ...
                                                            <div class="card-footer rating-card-footer bg-light border-top d-flex align-center justify-content-between">
                                                                <a class="switch-text collapsed" data-bs-toggle="collapse" href="#collapseDes3">
                                                                    <div class="link link-gray switch-text-normal">
                                                                        <span>Less Info</span><em class="icon ni ni-upword-ios"></em>
                                                                    </div>
                                                                    <div class="link link-gray switch-text-collapsed">
    ...
    &lt;/div&gt;
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Review form</h4>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="card card-bordered">
                                                                ...
                                                                <form action="#" class="mt-2">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="form-control-wrap">
                                                                            <input type="text" class="form-control" id="title" value="You only miss it when it gone!" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label class="form-label" for="job-title">Job Title</label>
                                                                        <div class="form-control-wrap">
                                                                            <input type="text" class="form-control" id="job-title" value="Sr. Frontend Developer" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label class="form-label" for="review">How was your experience?</label>
                                                                        <div class="form-control-wrap">
                                                                            <textarea class="form-control no-resize" id="review">I've been using Dashlite for months now and with every update, it's just becoming better. Thank you for such a great design touch. Really love it</textarea>
                                                                        </div>
                                                                    </div>
                                                                </form>
                                                                <h5 class="card-title mt-5">Criteria on Softnio</h5>
                                                                <div class="rating-card">
                                                                    <div class="d-flex align-center justify-content-between py-1">
                                                                        <span class="text-muted">Productivity</span>
                                                                        <ul class="rating">
                                                            ...
                                                            <div class="card-footer bg-light border-top d-flex align-center justify-content-end py-3">
                                                                <a href="#" class="btn btn-primary">Published Review</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="card card-bordered">
                                                            <div class="card-inner">
                                                                ...
                                                                <form action="#" class="mt-2">
                                                                    <div class="form-group">
                                                                        <label class="form-label" for="rt-title">Title</label>
                                                                        <div class="form-control-wrap">
                                                                            <input type="text" class="form-control" id="rt-title" placeholder="Title" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label class="form-label" for="rt-job-title">Job Title</label>
                                                                        <div class="form-control-wrap">
                                                                            <input type="text" class="form-control" id="rt-job-title" placeholder="Job Title" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label class="form-label" for="rt-review">How was your experience?</label>
                                                                        <div class="form-control-wrap">
                                                                            <textarea class="form-control no-resize" id="rt-review" placeholder="Describe your experience at Softnio"></textarea>
                                                                        </div>
                                                                    </div>
                                                                </form>
                                                                <h5 class="card-title mt-5">Criteria on Softnio</h5>
    ...
    &lt;/div&gt;
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Customers Ratings</h4>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                            ...
                                                            <div class="card-inner py-3">
                                                                <div class="d-sm-flex align-items-sm-center justify-content-sm-between">
                                                                    <div class="pb-1 pb-sm-0">
                                                                        ...
                                                                        <div class="d-flex">
                                                                            <p class="m-0 pe-2">by <a href="https://softnio.com" target="_blank">Softnio</a></p>
                                                        ...
                                                        <div class="card card-bordered">
                                                            <div class="card-inner border-bottom bg-lighter py-3">
                                                                <div class="d-sm-flex align-items-sm-center justify-content-sm-between">
                                                                    <div class="pb-1 pb-sm-0">
                                                                        ...
                                                                        <div class="d-sm-flex">
                                                                            <span class="m-0 pe-2">by <a href="https://softnio.com" target="_blank">Softnio</a></span>
                                                            ...
                                                            <div class="card-inner border-top">
                                                                <div class="d-flex">
                                                                    ...
                                                                    <div class="fake-class">
                                                                        <h6 class="mt-0 d-flex align-center"><span>Abu Bin Ishiyak</span><span class="badge badge-dim bg-outline-info ms-2">Author</span></h6>
                                                            ...
                                                            <div class="card-inner border-top">
                                                                <div class="d-flex">
                                                                    ...
                                                                    <div class="fake-class">
                                                                        <h6 class="mt-0 d-flex align-center"><span>Ifrat Binte</span></h6>
                                                                        <p class="text-soft">Thanks for the help. Really great support.</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div><!-- .card -->
        ...
        &lt;div class=&quot;card-inner py-3&quot;&gt;
            &lt;div class=&quot;d-flex align-center justify-content-between&quot;&gt;
                &lt;div&gt;
                    &lt;h5 class=&quot;title&quot;&gt;Design Quality&lt;/h5&gt;
                    &lt;div class=&quot;d-sm-flex&quot;&gt;
                        &lt;p class=&quot;m-0 pe-2&quot;&gt;by &lt;a href=&quot;#&quot;&gt;softnio&lt;/a&gt;&lt;/p&gt;
                        &lt;span&gt;13 days ago&lt;/span&gt;
                    &lt;/div&gt;
                &lt;/div&gt;
                &lt;ul class=&quot;rating&quot;&gt;
    ...
    &lt;div class=&quot;card card-bordered&quot;&gt;
        ...
        &lt;div class=&quot;card-inner border-top&quot;&gt;
            &lt;div class=&quot;d-flex&quot;&gt;
                ...
                &lt;/div&gt;
                &lt;div&gt;
                    &lt;h5 class=&quot;mt-0&quot;&gt;Abu Bin Ishiyak &lt;span class=&quot;badge badge-dim bg-outline-info ms-1&quot;&gt;Author&lt;/span&gt;&lt;/h5&gt;
                    &lt;p&gt;Thank you for your valuable feedback.&lt;/p&gt;
                    &lt;p&gt;Time zone depend on your server time as we use that by default. So you need to change that from your server. For data display issues, you may send your website url so we can check what actually wrong.&lt;/p&gt;
                &lt;/div&gt;
            &lt;/div&gt;
        &lt;/div&gt;
        &lt;div class=&quot;card-inner border-top&quot;&gt;
            &lt;div class=&quot;d-flex&quot;&gt;
                ...
                &lt;/div&gt;
                &lt;div&gt;
                    &lt;h5 class=&quot;mt-0&quot;&gt;Ifrat Binte&lt;span class=&quot;badge badge-dim bg-outline-success ms-1&quot;&gt;Purchased&lt;/span&gt;&lt;/h5&gt;
                    &lt;p&gt;Thanks for the help. Really great support.&lt;/p&gt;
                &lt;/div&gt;
            &lt;/div&gt;
        &lt;/div&gt;
    &lt;/div&gt;&lt;!-- .card --&gt;
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Customization</h4>
                                                <p>You can use customize rating icon for customizing the component.</p>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
