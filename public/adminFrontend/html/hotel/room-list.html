                                                                            ...
                                                                            <li>
                                                                                <div class="dropdown">
                                                                                    ...
                                                                                    <div class="filter-wg dropdown-menu dropdown-menu-xl dropdown-menu-end">
                                                                                        <div class="dropdown-head">
                                                                                            <span class="sub-title dropdown-title">Filter Rooms</span>
                                                                                            <div class="dropdown">
                                                ...
                                                <div class="card-search search-wrap" data-search="search">
                                                    <div class="card-body">
                                                        <div class="search-content">
                                                            ...
                                                            <input type="text" class="form-control border-transparent form-focus-none" placeholder="Search by room no or type">
                                            ...
                                            <div class="card-inner p-0">
                                                <div class="nk-tb-list nk-tb-ulist">
                                                    <div class="nk-tb-item nk-tb-head">
                                                        ...
                                                        <div class="nk-tb-col"><span class="sub-text">Room Type</span></div>
                                                        <div class="nk-tb-col tb-col-md"><span class="sub-text">AC/Non AC</span></div>
                                                        <div class="nk-tb-col tb-col-lg"><span class="sub-text">Meal</span></div>
                                                        <div class="nk-tb-col tb-col-lg"><span class="sub-text">Bed Capacity</span></div>
                                                                    ...
                                                                    <ul class="link-tidy sm no-bdr">
                                                                        <li>
                                                                            <div class="custom-control custom-control-sm custom-checkbox">
                                                                                ...
                                                                                <label class="custom-control-label" for="bo">Booked</label>
                                                                            </div>
                                                                        </li>
                                                                        <li>
                                                                            <div class="custom-control custom-control-sm custom-checkbox">
                                                                                <input type="checkbox" class="custom-control-input" checked="" id="open">
                                                                                <label class="custom-control-label" for="open">Open</label>
                                                                            </div>
                                                                        </li>
                                                                        <li>
                                                                            <div class="custom-control custom-control-sm custom-checkbox">
                                                                                <input type="checkbox" class="custom-control-input" id="inac">
                                                                                <label class="custom-control-label" for="inac">Inactive</label>
                                                                            </div>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <span class="text-primary">101</span>
                                                        </div>
                                                        <div class="nk-tb-col">
                                                            <span>Single <span class="dot dot-primary d-md-none ms-1"></span></span>
                                                        </div>
                                                        ...
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <span class="tb-amount">32.00 <span class="currency">USD</span></span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-md">
                                                            <span class="tb-status text-primary">Booked</span>
                                                        </div>
                                                            ...
                                                            <ul class="nk-tb-actions gx-1">
                                                                <li>
                                                                    <div class="drodown">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-end">
                                                                            <ul class="link-list-opt no-bdr">
                                                                                <li><a data-bs-toggle="modal" href="#edit-room"><em class="icon ni ni-edit"></em><span>Edit</span></a></li>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <span class="text-primary">102</span>
                                                        </div>
                                                        <div class="nk-tb-col">
                                                            <span>Single <span class="dot dot-warning d-md-none ms-1"></span></span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-md">
                                                            <span>AC</span>
                                                        </div>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <span>Double <span class="dot dot-success d-md-none ms-1"></span></span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-md">
                                                            <span>None</span>
                                                        </div>
                                                        ...
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <span class="tb-amount">44.99 <span class="currency">USD</span></span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-md">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <span class="tb-amount">48.99<span class="currency">USD</span></span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-md">
                                                            <span class="tb-status text-success">Open</span>
                                                        </div>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <span>Delux <span class="dot dot-primary d-md-none ms-1"></span></span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-md">
                                                            <span>None</span>
                                                        </div>
                                                        ...
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <span class="tb-amount">53.99<span class="currency">USD</span></span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-md">
                                                            <span class="tb-status text-primary">Booked</span>
                                                        </div>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <span class="text-primary">201</span>
                                                        </div>
                                                        <div class="nk-tb-col">
                                                            <span>Super Delux <span class="dot dot-primary d-md-none ms-1"></span></span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-md">
                                                            <span>AC</span>
                                                        </div>
                                                        ...
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <span class="tb-amount">68.99<span class="currency">USD</span></span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-md">
                                                            <span class="tb-status text-primary">Booked</span>
                                                        </div>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <span class="text-primary">202</span>
                                                        </div>
                                                        <div class="nk-tb-col">
                                                            <span>Super Delux <span class="dot dot-success d-md-none ms-1"></span></span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-md">
                                                            <span>AC</span>
                                                        </div>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <span>Suit<span class="dot dot-danger d-md-none ms-1"></span></span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-md">
                                                            <span>AC</span>
                                                        </div>
                                                        ...
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <span class="tb-amount">450<span class="currency">USD</span></span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-md">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <span class="text-primary">302</span>
                                                        </div>
                                                        <div class="nk-tb-col">
                                                            <span>Suit<span class="dot dot-danger d-md-none ms-1"></span></span>
                                                        </div>
                                                        ...
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <span class="tb-amount">499.99<span class="currency">USD</span></span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-md">
                                                            <span class="tb-status text-danger">Inactive</span>
                                                        </div>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <span class="text-primary">303</span>
                                                        </div>
                                                        <div class="nk-tb-col">
                                                            <span>Suit<span class="dot dot-danger d-md-none ms-1"></span></span>
                                                        </div>
                                                        ...
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <span class="tb-amount">999.99<span class="currency">USD</span></span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-md">
                                                            <span class="tb-status text-danger">Inactive</span>
                                                        </div>
