...
<head>
    ...
    <!-- Page Title  -->
    <title>Account Activity | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                                                ...
                                                <div class="card-inner-group" data-simplebar>
                                                    ...
                                                    <div class="card-inner p-0">
                                                        <ul class="link-list-menu">
                                                            <li><a href="html/hotel/settings.html"><em class="icon ni ni-user-fill-c"></em><span>General</span></a></li>
                                                            ...
                                                            <li><a class="active" href="html/hotel/settings-activity-log.html"><em class="icon ni ni-activity-round-fill"></em><span>Account activity</span></a></li>
                                                        </ul>
                                                    </div><!-- .card-inner -->
